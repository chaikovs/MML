function plot_6D_long_profile_surfLWFA_cont(phasespace,qm,Ef,nbin,fignum)
...
colormap(C1)
set(gca,'YDir','normal')
xlabel('E (MeV)');ylabel('X (mm)'); grid on;
xlim(limx);%ylim([-6 6])
grid on ;
