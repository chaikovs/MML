...
% If not Lattice given as argument, try the defaukt one
...
indexstruct = struct(ARGS{:}); % do not order the fields
indexstruct = orderfields(struct(ARGS{:})); % do not order the fields