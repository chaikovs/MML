...
% Modification Laurent S. Nadolski
% April 8th, 2007, which('DriftPass.c') instead of which('DriftPass')
...
switch computer
    ...
    case 'MACI64'
        %PLATFORMOPTION = [PLATFORMOPTION,'LDFLAGS=''-pthread -shared -m64''',' '];
        PLATFORMOPTION = [PLATFORMOPTION,'LDFLAGS='' -shared -m64''',' '];
otherwise
        fprintf('No extra option');
end
