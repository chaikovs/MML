...
% focalisation avec champ de fuite dans les dipoles - betax = 05 m entrée ANNEAU
QP1  =  quadrupole('QP', L,   0.7949193E+00, 'QuadLinearPass');
QP2  =  quadrupole('QP', L,  -.5540261E+00, 'QuadLinearPass');
QP3  =  quadrupole('QP', L,  -.8167426E+00 , 'QuadLinearPass');
QP4  =  quadrupole('QP', L,  0.1041258E+01 , 'QuadLinearPass');
QP5  =  quadrupole('QP', L,   0.1137955E+01 , 'QuadLinearPass');
QP6  =  quadrupole('QP', L,  -.1193550E+01 , 'QuadLinearPass');
QP7  =  quadrupole('QP', L,  0.2473256E+00 , 'QuadLinearPass');
...
%BEND  =  rbend('BEND', 1.052435,theta, theta/2, theta/2, 0.0,'BendLinearPass');

K = 0.00204;
fullgap = 0.037*0.724*2;
BEND  =  rbend2('BEND', 1.05243, theta, theta/2,theta/2, K,fullgap,'BendLinearPass');           
