...
% focalisation avec champ de fuite dans les dipoles - betax = 11 m entrée ANNEAU
QP1  =  quadrupole('QP', L, 1.0182  , 'QuadLinearPass');
QP2  =  quadrupole('QP', L, -0.6470 , 'QuadLinearPass');
QP3  =  quadrupole('QP', L, -0.7193  , 'QuadLinearPass');
QP4  =  quadrupole('QP', L, 1.0407  , 'QuadLinearPass');
QP5  =  quadrupole('QP', L, 0.9117   , 'QuadLinearPass');
QP6  =  quadrupole('QP', L, -1.1633  , 'QuadLinearPass');
QP7  =  quadrupole('QP', L, 0.6694   , 'QuadLinearPass');
