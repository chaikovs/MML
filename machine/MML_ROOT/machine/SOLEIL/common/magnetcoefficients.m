...
%
% NOTE: Q11 and Q12 are not well configured yet, just quick fix
         ...
         % G. Portmann
            ...
            case {'SEP_P'}
             ...
             case {'SEP_A'}
                ...
                vmax = 111;
                MagnetType = 'SEP_A';
                SBDL = 1147.8e-3 ; % Somme de Bdl mesuree a 111 V
                A = [0 SBDL/vmax 0]*Leff; 

             case {'KEMH'}
                % Horizontal pinger (KEM)
                Leff = 1.;
                vmax = 1000; % so scaling in kV
                MagnetType = 'KEMH';
                SBDL = 1.2e-3 ; 
                A = [0 SBDL/vmax 0]*Leff; 
...
%                 A = [a7 a6 a5 a4 a3 a2 a1 a0]; 
                ...
                % Alex updated 2013
                % G[T/m] = 0.0565 + 0.0518 I[A]
                % from BOO mesure mag 
                % Give the good tune at extraction in the booster 
                % ==> (6.57 - 4.60) measured in 2009
                Leff=0.400; 
                a8 =  0.0;
                a7 =  0.0;
                a6 =  0.0;
