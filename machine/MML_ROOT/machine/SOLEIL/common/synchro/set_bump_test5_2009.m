...
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k2.trigStepDelay',delai0+2    + k);
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k3.trigStepDelay',delai0+3    + k);
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k4.trigStepDelay',delai0-2    + k);


tango_write_attribute2('ANS-C01/EP/AL_K.1', 'voltage',5591*r-10 - 10);
tango_write_attribute2('ANS-C01/EP/AL_K.2', 'voltage',5630*r+10 - 10 ); 
tango_write_attribute2('ANS-C01/EP/AL_K.3', 'voltage',(5592*r-10 + 20)*r1 );
tango_write_attribute2('ANS-C01/EP/AL_K.4', 'voltage',(5566*r+05 - 15)*r1 ); 
