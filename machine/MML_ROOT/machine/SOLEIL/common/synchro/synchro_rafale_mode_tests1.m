...
%         tango_command_inout2('ANS-C01/SY/LOCAL.Ainj.2', 'Update');
 ...
 tango_write_attribute2('ANS/SY/CENTRAL', 'TInjStepDelay',timing.central_soft);
 tango_write_attribute2('ANS/SY/CENTRAL', 'TSoftStepDelay',timing.central_inj);       
