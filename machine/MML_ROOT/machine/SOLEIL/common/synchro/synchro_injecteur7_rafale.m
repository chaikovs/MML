function varargout = synchro_injecteur7_rafale(varargin)
% SYNCHRO_INJECTEUR7_RAFALE M-file for synchro_injecteur7_rafale.fig
...
% Edit the above text to modify the response to help synchro_injecteur7_rafale

% Last Modified by GUIDE v2.5 02-Oct-2008 16:05:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @synchro_injecteur7_rafale_OpeningFcn, ...
                   'gui_OutputFcn',  @synchro_injecteur7_rafale_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before synchro_injecteur7_rafale is made visible.
function synchro_injecteur7_rafale_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to synchro_injecteur7_rafale (see VARARGIN)

% Choose default command line output for synchro_injecteur7_rafale
...
h = uibuttongroup('visible','off','Position',[0.141 0.37 0.11 0.14],...
...
% UIWAIT makes synchro_injecteur7_rafale wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = synchro_injecteur7_rafale_OutputFcn(hObject, eventdata, handles) 
