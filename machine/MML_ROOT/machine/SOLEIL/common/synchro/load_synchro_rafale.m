...
tout=0.;
    ...
    if isfield(timing,'inj_offset');inj_offset=timing.inj_offset;
       if isfield(timing,'ext_offset');ext_offset=timing.ext_offset;
           if isfield(timing,'lin_fin'   );lin_fin   =timing.lin_fin;
              FileName = [DirName 'synchro_offset_lin.mat'];
    ...
    tango_write_attribute2('ANS/SY/CENTRAL', 'TPcTimeDelay',290000);
    tango_write_attribute2('ANS/SY/CENTRAL', 'TInjTimeDelay',290010);
    tango_write_attribute2('ANS/SY/CENTRAL', 'TSoftTimeDelay',290020);
    tango_write_attribute2('ANS/SY/CENTRAL', 'TSprTimeDelay',290030);
    tango_write_attribute2('ANS/SY/CENTRAL', 'ExtractionOffsetTimeValue',290080);
    
    tango_write_attribute2('ANS/SY/LOCAL.SDC.1', 'oscStepDelay',timing.sdc1(1));pause(tout);
    tango_write_attribute2('LIN/SY/LOCAL.LPM.1', 'lpmStepDelay',timing.lin_lpm(1));pause(tout);
    tango_write_attribute2('LIN/SY/LOCAL.LPM.1', 'spareStepDelay',timing.lin_modulateur(1));
    if isfield(timing,'lin_spm');tango_write_attribute2('LIN/SY/LOCAL.SPM.1', 'spmLinacStepDelay',timing.lin_spm(1));pause(tout);end
    if isfield(timing,'lin_alim');tango_write_attribute2('LT1/SY/LOCAL.DG.1', 'libre.1StepDelay',timing.lin_alim(1));pause(tout);end
    tango_write_attribute2('BOO/SY/LOCAL.DG.1', 'bpm-bta.trigStepDelay',timing.boo_bpm(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.DG.1', 'bpm-btd.trigStepDelay',timing.boo_bpm(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.DG.2', 'bpm-btb.trigStepDelay',timing.boo_bpm(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.DG.3', 'bpm-btc.trigStepDelay',timing.boo_bpm(1));pause(tout);     
    tango_write_attribute2('LT1/SY/LOCAL.DG.1', 'emittanceStepDelay',timing.lt1_emittance(1));pause(tout);
    tango_write_attribute2('LT1/SY/LOCAL.DG.1', 'mc.1StepDelay',timing.lt1_mc1(1));pause(tout);
    tango_write_attribute2('LT1/SY/LOCAL.DG.1', 'mc.2StepDelay',timing.lt1_mc2(1));pause(tout);
    tango_write_attribute2('LT1/SY/LOCAL.DG.1', 'oscStepDelay',timing.lt1_osc(1));pause(tout);
    tango_write_attribute2('LT1/SY/LOCAL.DG.1', 'dcct-booStepDelay',timing.boo_dcct(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.DG.3', 'bpm-onde.trigStepDelay',timing.boo_nod(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.Binj.1', 'sep-p.trigStepDelay',timing.boo_sep_p_inj(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.Binj.1', 'k.trigStepDelay',timing.boo_k_inj(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.ALIM.1', 'dpStepDelay',timing.boo_dp(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.ALIM.1', 'qfStepDelay',timing.boo_qf(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.ALIM.1', 'qdStepDelay',timing.boo_qd(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.ALIM.1', 'sfStepDelay',timing.boo_sf(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.ALIM.1', 'sdStepDelay',timing.boo_sd(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.ALIM.1', 'compStepDelay',timing.boo_cp(1));pause(tout);
    tango_write_attribute2('BOO/SY/LOCAL.RF.1', 'rfStepDelay',timing.boo_rf(1));pause(tout);
    tango_write_attribute2('ANS/SY/LOCAL.SDC.1', 'spareStepDelay',timing.sdc2(1));pause(tout);
    ...
    if isfield(timing,'lt2_ict');tango_write_attribute2('ANS-C16/SY/LOCAL.DG.1', 'mcLT2.trigStepDelay',timing.lt2_ict(1));end
    ...
    tango_write_attribute2('ANS-C14/SY/LOCAL.DG.1', 'perteStepDelay',timing.ans_dcct(1));pause(tout);  
    if isfield(timing,'ans_nod') ;tango_write_attribute2('ANS-C08/SY/LOCAL.DG.1', 'bpm.pmStepDelay',timing.ans_nod(1));pause(tout);end  
    if isfield(timing,'ans_nodC09') ;tango_write_attribute2('ANS-C09/SY/LOCAL.DG.1', 'bpm.pmStepDelay',timing.ans_nodC09(1));pause(tout);end 
    if isfield(timing,'ans_fbt') ;tango_write_attribute2('ANS-C07/SY/LOCAL.DG.1', 'fbt.StepDelay',timing.ans_fbt(1));pause(tout);end
    ...
    if isfield(timing,'lin_alim');tango_write_attribute2('LT1/SY/LOCAL.DG.1', 'libre.1Event',int32(timing.lin_alim(2)));pause(tout);end
    ...
    tango_write_attribute2('BOO/SY/LOCAL.ALIM.1', 'compEvent',int32(timing.boo_cp(2)));pause(tout);
    ...
    if isfield(timing,'lt2_ict');tango_write_attribute2('ANS-C16/SY/LOCAL.DG.1', 'mcLT2.trigEvent',timing.lt2_ict(1));end
    ...
    tango_write_attribute2('ANS-C14/SY/LOCAL.DG.1', 'perteEvent',int32(timing.ans_dcct(2)));pause(tout);
    if isfield(timing,'ans_nod') ;tango_write_attribute2('ANS-C08/SY/LOCAL.DG.1', 'bpm.pmEvent',int32(timing.ans_nod(2)));pause(tout);end  
    if isfield(timing,'ans_nodC09') ;tango_write_attribute2('ANS-C09/SY/LOCAL.DG.1', 'bpm.pmEvent',int32(timing.ans_nodC09(2)));pause(tout);end  
    if isfield(timing,'ans_fbt') ;tango_write_attribute2('ANS-C09/SY/LOCAL.DG.1', 'fbt.Event',int32(timing.ans_fbt(2)));pause(tout);end
