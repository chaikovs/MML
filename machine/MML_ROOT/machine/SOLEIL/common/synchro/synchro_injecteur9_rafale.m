function varargout = synchro_injecteur9_rafale(varargin)
% SYNCHRO_INJECTEUR9_RAFALE M-file for synchro_injecteur9_rafale.fig
%      SYNCHRO_INJECTEUR9_RAFALE, by itself, creates a new SYNCHRO_INJECTEUR9_RAFALE or raises the existing
%      singleton*.
%
%      H = SYNCHRO_INJECTEUR9_RAFALE returns the handle to a new SYNCHRO_INJECTEUR9_RAFALE or the handle to
%      the existing singleton*.
%
%      SYNCHRO_INJECTEUR9_RAFALE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SYNCHRO_INJECTEUR9_RAFALE.M with the given input arguments.
%
%      SYNCHRO_INJECTEUR9_RAFALE('Property','Value',...) creates a new SYNCHRO_INJECTEUR9_RAFALE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before synchro_injecteur8_rafale_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to synchro_injecteur9_rafale_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help synchro_injecteur9_rafale

% Last Modified by GUIDE v2.5 28-Jan-2013 13:31:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @synchro_injecteur9_rafale_OpeningFcn, ...
                   'gui_OutputFcn',  @synchro_injecteur9_rafale_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before synchro_injecteur9_rafale is made visible.
function synchro_injecteur9_rafale_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to synchro_injecteur9_rafale (see VARARGIN)

% Choose default command line output for synchro_injecteur9_rafale
...
% UIWAIT makes synchro_injecteur9_rafale wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = synchro_injecteur9_rafale_OutputFcn(hObject, eventdata, handles) 
...
FileName = [handles.DirName 'synchro_offset_lin.mat'];
...
if strcmp(h,'Yes')
    ...
    [stat,mess]=fileattrib(file);
    if mess.UserWrite ==0
        fileattrib(file,'+w', 'u'); % force writtable file
    end
...
% --- Executes on button press in button_load_silver_3Hz.
function button_load_silver_3Hz_Callback(hObject, eventdata, handles)
% hObject    handle to button_load_silver_3Hz (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[etat_central]=test_central_mode(handles);
h='Yes';
...
% --- Executes on button press in button_save_silver_3Hz.
function button_save_silver_3Hz_Callback(hObject, eventdata, handles)
% hObject    handle to button_save_silver_3Hz (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
h = questdlg('Attention, sauvegarde nouvelle silver !!!');
