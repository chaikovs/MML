...
%
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k1.trigStepDelay',delai0 -1  +2  + k);
...
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k4.trigStepDelay',delai0 +2  -2  + k);

%
tango_write_attribute2('ANS-C01/EP/AL_K.1', 'voltage',(5566+20 )*r);
tango_write_attribute2('ANS-C01/EP/AL_K.2', 'voltage',(5644+20 )*r); 
