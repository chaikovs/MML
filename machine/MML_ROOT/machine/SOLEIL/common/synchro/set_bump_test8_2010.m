...
delai0 =5621670-40;
r=1.0;    % ratio global
r1=1.03 ;   % ratio 2 derniers kicker
k=-0;

%
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k1.trigStepDelay',delai0 -1  +3  + k);
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k2.trigStepDelay',delai0 +6  -3 +2 + k);
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k3.trigStepDelay',delai0 -2  +3  -1 + k);
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k4.trigStepDelay',delai0 +2  -3  + k);

%
tango_write_attribute2('ANS-C01/EP/AL_K.1', 'voltage',(5566-10 )*r);
tango_write_attribute2('ANS-C01/EP/AL_K.2', 'voltage',(5644+10 )*r); 
tango_write_attribute2('ANS-C01/EP/AL_K.3', 'voltage',(5543+50 )*r);
tango_write_attribute2('ANS-C01/EP/AL_K.4', 'voltage',(5619-50 )*r); 
