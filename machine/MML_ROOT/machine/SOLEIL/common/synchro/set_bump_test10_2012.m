...
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k2.trigStepDelay',delai0 +11    );
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k3.trigStepDelay',delai0 +4     );
tango_write_attribute2('ANS-C01/SY/LOCAL.Ainj.1', 'k4.trigStepDelay',delai0 +4     );

return
%
tango_write_attribute2('ANS-C01/EP/AL_K.1', 'voltage',(5566+20+0 )*r);
tango_write_attribute2('ANS-C01/EP/AL_K.2', 'voltage',(5644+20-0 )*r); 
tango_write_attribute2('ANS-C01/EP/AL_K.3', 'voltage',(5543+40-0 )*r);
tango_write_attribute2('ANS-C01/EP/AL_K.4', 'voltage',(5619-30+0 )*r); 
