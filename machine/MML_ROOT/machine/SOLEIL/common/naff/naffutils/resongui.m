...
% Last Modified by GUIDE v2.5 16-Apr-2011 23:34:51
...
handles.dataname = 'fmapn.out'; % carte par defaut
...
% OBLIGATOIRE car la fonction loaddata a modifie handles et 
...
children=get(handles.fmap,'Children');
...
switch handles.color
    ...
    case 'on'
        ...
        switch handles.color
            case 'off'
                mesh(handles.fxgrid,handles.fzgrid, handles.diffu,'LineStyle','.','MarkerSize',5.0,'FaceColor','none','Tag','fspace');
            case 'on'
        ...
        switch handles.color
            case 'off'
                mesh(handles.xgrid,handles.zgrid,handles.diffu,'LineStyle','.','MarkerSize',5.0,'FaceColor','none','Tag','cspace');
            case 'on'
                mesh(handles.xgrid,handles.zgrid,handles.diffu,'Marker','.','MarkerSize',5.0,'FaceColor','none','LineStyle','none','Tag','fspace');
        end
...
% --- Executes on button press in radiobutton_zoom.
function radiobutton_zoom_Callback(hObject, eventdata, handles)
% hObject    handle to radiobutton_zoom (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of radiobutton_zoom
mutual_exclude(handles.radiobutton_shift);
handles.type='zoom';
guidata(hObject, handles);

% --- Executes on button press in radiobutton_shift.
function radiobutton_shift_Callback(hObject, eventdata, handles)
% hObject    handle to radiobutton_shift (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of radiobutton_shift
mutual_exclude(handles.radiobutton_zoom);
handles.type='shift';
guidata(hObject, handles);
