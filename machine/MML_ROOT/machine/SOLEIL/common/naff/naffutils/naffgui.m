...
% Last Modified by GUIDE v2.5 23-Sep-2015 15:47:11
...
% ces 2 autres versions permettent de superposer des r�sultats TRACY en
% couleurs et les mesures on-momentum en noir sur la figure(1000)
% pr�requis : fmap.out de TRACY -> fmap_simulation.out
...
num_lines = 1;
def = {'momentumacceptance.out','linlat.out', '3.87E-9', ...
    '6.0E-3', '1.0', '1E-2',  '2.739', '1'};
