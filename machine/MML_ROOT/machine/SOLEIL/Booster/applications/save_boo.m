...
% AUGUST 29TH, 2007 :  PATH MODIFIED USING GENERIC FUNCTIONS
...
% UIWAIT makes save_b
% Directory = '/home/production/matlab/matlabML/measdata/Boosterdata/Datatemp';
% pwdold = pwd;
% cd(Directory);
% 
...
% sur     PSTopUpModeManager
%     writeattribute('BOO/AE/PSTopUpModeManager/iNomD1',boo.DIPcurrent);
%     writeattribute('BOO/AE/PSTopUpModeManager/iNomD2',boo.DIPcurrent);
    writeattribute('BOO/AE/PSTopUpModeManager/iNomQF',boo.QFcurrent);
    writeattribute('BOO/AE/PSTopUpModeManager/iNomQD',boo.QDcurrent);
    writeattribute('BOO/AE/PSTopUpModeManager/iNomSF',boo.SFcurrent);
    writeattribute('BOO/AE/PSTopUpModeManager/iNomSD',boo.SDcurrent);
...
%     writeattribute('BOO-C12/EP/AL_SEP_A.Ext/voltage,',boo.SAEXTvoltage);
  ...
  tango_write_attribute2('BOO/SY/LOCAL.ALIM.1', 'qfTimeDelay',boo.QFdelay);
  tango_write_attribute2('BOO/SY/LOCAL.ALIM.1', 'qdTimeDelay',boo.QDdelay);
