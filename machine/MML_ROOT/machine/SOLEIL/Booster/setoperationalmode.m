...
AD.Directory.DataRoot       = fullfile(MMLDATAROOT, 'measdata', 'SOLEIL', 'Boosterdata', filesep);
AD.Directory.OpsData        = fullfile(getmmlconfigroot, 'machine', 'SOLEIL', 'BoosterOpsData', filesep);
...
AD.Directory.ConfigData     = fullfile(getmmlconfigroot, 'machine', 'SOLEIL', 'Booster', 'MachineConfig', filesep);
