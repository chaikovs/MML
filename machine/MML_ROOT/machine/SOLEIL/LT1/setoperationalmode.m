...
AD.Directory.DataRoot       = fullfile(MMLDATAROOT, 'measdata', 'SOLEIL', 'LT1data', filesep);
AD.Directory.OpsData        = fullfile(getmmlconfigroot, 'machine', 'SOLEIL', 'LT1OpsData', filesep);
AD.Directory.Lattice        = fullfile(MMLROOT, 'machine', 'SOLEIL', 'LT1', 'Lattices', filesep);

AD.Directory.FAEData        = fullfile(AD.Directory.DataRoot, 'fae', filesep);
AD.Directory.EMITData       = fullfile(AD.Directory.DataRoot, 'emittance', filesep); 
AD.Directory.Timing         = fullfile(MMLROOT, 'machine', 'SOLEIL', 'LT1', 'Timing', filesep);

AD.Directory.ConfigData     = fullfile(getmmlconfigroot, 'machine', 'SOLEIL', 'LT1', 'MachineConfig', filesep);
