...
THERING = setcellstruct(THERING,'Roll',[findcells(THERING,'FamName','CH') findcells(THERING,'FamName','CV')], 0.0 ,[1 2],[1 2 3]);
THERING = setcellstruct(THERING,'Gain',[findcells(THERING,'FamName','CH') findcells(THERING,'FamName','CV')] ,1.0, [1 2 3]');
disp('** Done **');
