...
%%    sumcolumn=sumcolumn-handles.vect_colonne_noire; % suppression le 07 mai 08 !
else
...
if isequal(size(sumrow),size(handles.vect_ligne_noire))
    % on soustraie l'image sans faisceau
%%%    sumrow=sumrow-handles.vect_ligne_noire; % suppression le 07 mai 08 !
else
...
if isequal(handles.largeur_option,2)
    ...
    % test !
%Z = load('-mat','/home/production/matlab/matlabML/measdata/LT1data/emittance/2005-10-10_4/profilH_2_38.mat');
%Z = load('-mat','/home/production/matlab/matlabML/measdata/LT1data/emittance/2005-09-23_1/profilH_3_38.mat');
% Z = load('-mat','/home/production/matlab/matlabML/measdata/LT1data/emittance/2005-10-10_4/profilH_3_38.mat');
% sumcolumn = Z.vect_H;
...
if isequal(handles.largeur_option,2)
        ...
        % test !
%ZV = load('-mat','/home/production/matlab/matlabML/measdata/LT1data/emittance/2005-10-10_4/profilV_2_38.mat');
% ZV = load('-mat','/home/production/matlab/matlabML/measdata/LT1data/emittance/2005-10-10_4/profilV_3_38.mat');
% sumrow = ZV.vect_V;
