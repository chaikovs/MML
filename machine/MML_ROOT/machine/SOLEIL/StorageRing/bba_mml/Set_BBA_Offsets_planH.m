function Set_BBA_Offsets_planH(offsets_array, varargin)
%function Set_BBA_Offsets_planH - Apply H-plane BBA offsets to liberas
%
%  INPUTS
...
%
%  See also Set_BBA_Offsets_planV
...
if ~isempty(varargin)
    ...
    load([getfamilydata('Directory', 'BBA'),'/2010-01-22/tableBBAH.mat']);
    %load('/home/production/matlab/matlabML/measdata/SOLEIL/StorageRingdata/BBA/2009-06-19_b/tableBBAH.mat');
    %load('/home/production/matlab/matlabML/measdata/Ringdata/BBA/work2/tableBBAH.mat');
    %load('/home/production/matlab/matlabML/measdata/Ringdata/QUAD/tableBPM.mat');
end
