...
doubleBPMList = [doubleBPMListQ2Q3 ; doubleBPMListQ4Q5 ; doubleBPMListQ6Q7; doubleBPMListQ11Q12];
...
%     end
    ...
    subplot(2,1,1);
    if ~isempty(X)
        errorbar(Offsetx(:,5), Offsetx(:,3), Offsetx(:,4), '.b');
    end
    ...
    subplot(2,1,2);
    if ~isempty(Y)
        errorbar(Offsety(:,5), Offsety(:,3), Offsety(:,4), '.b');
    end
