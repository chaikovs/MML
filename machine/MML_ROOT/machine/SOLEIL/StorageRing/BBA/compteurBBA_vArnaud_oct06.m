...
cd(fullfile(getfamilydata('Directory', 'BBA'), filesep, 'work2'));
...
%cd '/home/production/matlab/matlabML/mmlcontrol/Ringspecific/fonction_test/'%Sauvegarde_beta_sept06 (betameasX,betameasZ)

% Load betafunctions given by MAT
% TO BE IMPROVED for a bit wrong and not generic
cd(fullfile(getfamilydata('Directory', 'QUAD')));
...
%%
cd(fullfile(getfamilydata('Directory', 'BBA'), filesep, 'debug'));
%
