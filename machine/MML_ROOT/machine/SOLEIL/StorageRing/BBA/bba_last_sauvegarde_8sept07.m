...
%                 A = BpmVal(1:120,v,u) ;
%                 I = find(abs(A)>0.7); % critère du test = 0.7 mm en absolu
%                 if ~isempty(I)&Plane==2
%                     disp(strcat('Quadrupole :',QuadFam,QuadDev)); % nom du quad et valeur du deltaQ
%                     fprintf('delta I sur ce quad : %6.2f  A\n',DeltaQp);
%                     disp( strcat('Correcteur :',QuadFam,QuadDev)); % nom du correcteur et valeur du deltacor
