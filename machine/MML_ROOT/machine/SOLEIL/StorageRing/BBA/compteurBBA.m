...
%cd '/home/production/matlab/matlabML/measdata/Ringdata/BBA/debug'
...
if testV~=0
    ...
    hist(ordonneV,20)
    xlabel('Zoffset [mm]');
    ylabel('Nb de BPM'); grid on;
end
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
disp('HPLANE')
%disp(recaH); % pose pb a l'excecution 13 sep 07 !??
...
%cd '/home/production/matlab/matlabML/mml/machine/Soleil/StorageRing/quad//fonction_test/'%Sauvegarde_beta_sept06 (betameasX,betameasZ)
%%
...
% % % h1 = subplot(5,1,[1 4]);
% % % hold on
% % % plot(abscissex,str2num(char(tableBBAH{:,2})),'bo-')
% % % ylabel('Computed Xoffset (mm)');
% % % h2 = subplot(5,1,5);
% % % drawlattice; % Draw lattice
% % % xlabel('s (m)');
% % % linkaxes([h1 h2],'x')
% % % set([h1 h2],'XGrid','On','YGrid','On');
