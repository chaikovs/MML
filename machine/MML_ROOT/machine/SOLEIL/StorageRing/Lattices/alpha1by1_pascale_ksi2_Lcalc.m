...
CAV = rfcavity('RF' , 0 , 2.4e+6 , HarmNumber*C0/L0, ...
    HarmNumber ,'CavityPass');
...
SD2 = drift('SD2',  0.36520, 'DriftPass');
SD3 = drift('SD3',   0.1786, 'DriftPass');
%SD4 = drift('SD4',  0.39000, 'DriftPass');
%SD14= drift('SD14', 0.59000, 'DriftPass');
SD5 = drift('SD5',  0.175200, 'DriftPass');
SD6 = drift('SD6',  0.79000, 'DriftPass');
SD7 = drift('SD7',  0.4152000, 'DriftPass');
SD8 = drift('SD8',  0.175200, 'DriftPass');
%SD9 = drift('SD9',  0.47634, 'DriftPass');
%SD10= drift('SD10', 0.47000, 'DriftPass');
SD12= drift('SD12', 0.445200, 'DriftPass');
%SDAC= drift('SDAC', 1.90468, 'DriftPass');

% SD existantes et modifiees
SD1d = drift('SD1d',  0.5170, 'DriftPass');
SD14a = drift('SD14a', 0.3803000, 'DriftPass');
SD9a = drift('SD9a',  0.19950	, 'DriftPass');
SD10a = drift('SD10a', 0.167600	, 'DriftPass');
...
SD91 = drift('SD91',  0.2465400, 'DriftPass');
SD41 = drift('SD41',  0.2521, 'DriftPass');
SD42 = drift('SD42',  0.205, 'DriftPass');
SD92 = drift('SD92',  0.199600, 'DriftPass');
SD93 = drift('SD93',  0.246600	, 'DriftPass');
SD43 = drift('SD43', 0.2051	, 'DriftPass');
%SD101 = drift('SD101', 0.2394, 'DriftPass');
SD141 = drift('SD141', 0.427200, 'DriftPass');

SDB1 = drift('SDB1',  0.286300, 'DriftPass');
SDB2 = drift('SDB2', 0.16350, 'DriftPass');
SDB3 = drift('SDB3', 0.252,  'DriftPass');
SDB4 = drift('SDB4', 0.2776 ,'DriftPass');
SDB5 = drift('SDB5', 0.205  ,'DriftPass');
SDB6 = drift('SDB6', 0.116500 ,'DriftPass');
SDB7 = drift('SDB7', 0.16360 , 'DriftPass');
SDB8 = drift('SDB8', 0.252 , 'DriftPass');
SDB9 = drift('SDB9', 0.116500 ,'DriftPass');
SDB10= drift('SDB10',0.16360 , 'DriftPass');
SDB11= drift('SDB11',0.2519, 'DriftPass');
SDB12= drift('SDB12',0.2049, 'DriftPass');
SDB13= drift('SDB13',0.11650, 'DriftPass');
SDB14= drift('SDB14',0.16350, 'DriftPass');
SDB15= drift('SDB15',0.252 , 'DriftPass');
%SDB16= drift('SDB16',0.2306 , 'DriftPass');
SDB17= drift('SDB17',0.205 , 'DriftPass');
SDB18= drift('SDB18',0.11660 , 'DriftPass');

SDC1 = drift('SDC1' , 0.237200 ,  'DriftPass');
...
SDC8 = drift('SDC8' ,0.237200 ,  'DriftPass');
SDC9 = drift('SDC9' , 0.079  , 'DriftPass');
SDC10= drift('SDC10',0.07845, 'DriftPass');
SDC11= drift('SDC11',0.23720  , 'DriftPass');
...
SDC16= drift('SDC16',0.23720 , 'DriftPass');
SDC17= drift('SDC17',0.079  , 'DriftPass');
SDC18= drift('SDC18',0.07845, 'DriftPass');
SDC19= drift('SDC19',0.23720  , 'DriftPass');
SDC20= drift('SDC20',0.237200  , 'DriftPass');
SDC21= drift('SDC21',0.079  , 'DriftPass');
SDC22= drift('SDC22',0.286200  , 'DriftPass');
...
LQC = 0.184800E+00 * 2 ;
LQL = 0.251400E+00 * 2 ;
Q1   =  quadrupole('Q1' , LQC,  -.1263712E+01*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,   0.1659220E+01*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -.5020591E+00*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -.9976440E+00*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,   0.1591820E+01*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -.1576059E+01*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,   0.1877264E+01*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  -.3570547E+00*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -.1172185E+01*de , 'QuadLinearPass');
Q10  =  quadrupole('Q10', LQC,   0.1640029E+01*de , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  2.281964*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv, -3.631550*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv, -3.158907*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  4.910700*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv, -3.092437*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  2.647260*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv, -2.428377*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  2.356279*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv, -2.928590*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  1.869324*F, 'StrMPoleSymplectic4Pass');
