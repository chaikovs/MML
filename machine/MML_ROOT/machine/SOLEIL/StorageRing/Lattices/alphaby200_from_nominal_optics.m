...
LQC = 0.180100E+00 * 2 ;
LQL = 0.248100E+00 * 2 ;
Q1   =  quadrupole('Q1' , LQC,  -1.396813*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,   1.631540*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -0.4815715*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -1.334138*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,   1.739316*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -0.9372326*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,   2.181532*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  -1.590172*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -1.489289*de , 'QuadLinearPass');
Q10  =  quadrupole('Q10', LQC,   1.711034*de , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  1.4860*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv,  -4.0105*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv,  -2.5483*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  3.8548*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv,  -2.4139*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  3.3880*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv,  -5.5000*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  4.5798*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv,  -1.6524*F, 'StrMPoleSymplectic4Pass');
S10  =  sextupole('S10' , Finv,  1.2219*F, 'StrMPoleSymplectic4Pass');
S11  =  sextupole('S11' , Finv,  1.4860*F, 'StrMPoleSymplectic4Pass');
