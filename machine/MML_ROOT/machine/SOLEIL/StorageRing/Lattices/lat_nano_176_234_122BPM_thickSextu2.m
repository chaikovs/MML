function varargout = lat_nano_176_234_122BPM_thickSextu2 
...
S1  =  sextupole('S1' , Lsextu,  0.300*5*Finv, SPassMethod);
S2  =  sextupole('S2' , Lsextu, -0.715*5*Finv, SPassMethod);
S3  =  sextupole('S3' , Lsextu, -0.338*5*Finv, SPassMethod);
S4  =  sextupole('S4' , Lsextu,  0.697*5*Finv, SPassMethod);
S5  =  sextupole('S5' , Lsextu, -0.672*5*Finv, SPassMethod);
...
S9  =  sextupole('S9' , Lsextu, -0.791*5*Finv, SPassMethod);
S10 =  sextupole('S10', Lsextu,  0.468*5*Finv, SPassMethod);
S11 =  sextupole('S11', Lsextu,  0.300*5*Finv, SPassMethod);
S12 =  sextupole('S12', Lsextu,  1.000E-10*Finv*0, SPassMethod); % to be drawn by drawlattice
