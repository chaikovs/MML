function varargout = lat_like_nanoscopium_juin2011 
% fonction beta comme Nanoscopium
...
L0 = 354.0968203999998+1e-12;% design length [m]
...
Q1   =  quadrupole('Q1' , LQC, -1.26474,  'StrMPoleSymplectic4Pass');
Q2   =  quadrupole('Q2' , LQL,  1.709483, 'StrMPoleSymplectic4Pass');
Q3   =  quadrupole('Q3' , LQC, -0.6532966,'StrMPoleSymplectic4Pass');
Q4   =  quadrupole('Q4' , LQC, -1.191092, 'StrMPoleSymplectic4Pass');
Q5   =  quadrupole('Q5' , LQC,  1.70555,  'StrMPoleSymplectic4Pass');
Q6   =  quadrupole('Q6' , LQC, -1.232844, 'StrMPoleSymplectic4Pass');
Q7   =  quadrupole('Q7' , LQL,  2.05284,  'StrMPoleSymplectic4Pass');
Q8   =  quadrupole('Q8' , LQC, -1.396382, 'StrMPoleSymplectic4Pass');
Q9   =  quadrupole('Q9' , LQC, -1.334399, 'StrMPoleSymplectic4Pass');
Q10  =  quadrupole('Q10', LQC,  1.727884, 'StrMPoleSymplectic4Pass');
...
S1  =  sextupole('S1' , Finv,  0.343838*5*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv, -0.6283534*5*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv, -0.4724375*5*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  0.8128982*5*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv, -0.755816*5*F,  'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  0.6088501*5*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv, -1.030959*5*F,  'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  0.8083523*5*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv, -0.7188769*5*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  0.4461458*5*F, 'StrMPoleSymplectic4Pass');
S11 =  sextupole('S11', Finv,  0.343838*5*F,  'StrMPoleSymplectic4Pass');
...
ELIST = [DEBUT SECT1 SUP1 SECT2 SUP2 SECT3 SUP3 SECT4 SUP4 CAV FIN];
