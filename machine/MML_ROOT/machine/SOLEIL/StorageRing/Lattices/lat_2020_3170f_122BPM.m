...
% (200 um larger)
% December 2011 - In this file : Q and S values for the nominal user mode until nov 2010
...
Q1   =  quadrupole('Q1' , LQC, -0.1073038E+01,  QPassMethod);
Q2   =  quadrupole('Q2' , LQL,   0.1603455E+01, QPassMethod);
Q3   =  quadrupole('Q3' , LQC, -0.6491600E+00,QPassMethod);
Q4   =  quadrupole('Q4' , LQC, -0.1259864E+01, QPassMethod);
Q5   =  quadrupole('Q5' , LQC,   0.1696440E+01,  QPassMethod);
Q6   =  quadrupole('Q6' , LQC,  -0.1007805E+01, QPassMethod);
Q7   =  quadrupole('Q7' , LQL,  0.2085280E+01,  QPassMethod);
Q8   =  quadrupole('Q8' , LQC, -0.1551946E+01, QPassMethod);
Q9   =  quadrupole('Q9' , LQC, -0.1513545E+01, QPassMethod);
Q10  =  quadrupole('Q10', LQC, 0.1756880E+01, QPassMethod);
