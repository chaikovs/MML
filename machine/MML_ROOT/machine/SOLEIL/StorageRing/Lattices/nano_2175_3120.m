...
L0 = 354.0968348667076;      % design length [m] + chicane PX2
...
LQC = 0.180100E+00*2;
LQL = 0.248100E+00*2;
Q1   =  quadrupole('Q1' , LQC,  -9.69424e-01 , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,   1.59347e+00 , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -8.09969e-01, 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -1.20533e+00, 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,   1.69175e+00, 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -1.09469e+00, 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,   2.05285e+00 , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  -1.41004e+00, 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -1.45109e+00 , 'QuadLinearPass');
Q10  =  quadrupole('Q10', LQC,   1.76057e+00 , 'QuadLinearPass');
Q11  =  quadrupole('Q11', LQC,  -1.88950e+00, 'QuadLinearPass');
Q12  =  quadrupole('Q12', LQL,   1.86550e+00 , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  1.585e+00*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv, -3.661e+00*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv, -2.169e+00*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  3.605e+00*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv, -3.173e+00*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  3.111e+00*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv, -4.716e+00*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  3.952e+00*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv, -3.660e+00*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  2.235e+00*F, 'StrMPoleSymplectic4Pass');
