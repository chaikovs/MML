function varargout = lat_nano_2000_7000
...
LQC = 0.180100E+00*2;
LQL = 0.248100E+00*2;
Q1   =  quadrupole('Q1' , LQC,  -0.9511244E+00 , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,   0.1596755E+01 , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -0.8461094E+00 , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -0.1164016E+01 , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,   0.1678988E+01 , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -0.1152619E+01 , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,   0.2081727E+01 , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  -0.1464629E+01 , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -0.1436643E+01 , 'QuadLinearPass');
Q10  =  quadrupole('Q10', LQC,   0.1757550E+01 , 'QuadLinearPass');
Q11  =  quadrupole('Q11', LQC,  -0.1830775E+01 , 'QuadLinearPass');
Q12  =  quadrupole('Q12', LQL,   0.1801931E+01 , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  0.3438380E+00*F*5, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv, -0.7993242E+00*F*5, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv, -0.5408313E+00*F*5, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  0.7209300E+00*F*5, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv, -0.7052902E+00*F*5, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  0.6493340E+00*F*5, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv, -0.1000704E+01*F*5, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  0.8387440E+00*F*5, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv, -0.5224938E+00*F*5, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  0.3890300E+00*F*5, 'StrMPoleSymplectic4Pass');
