function varargout = lat_nano_176_234_122BPM_tempo_v2 
...
SDTEMPO1 = drift('SDTEMPO1', 0.35000, 'DriftPass');
SDTEMPO2 = drift('SDTEMPO2', 1.15055, 'DriftPass');
SDTEMPO3 = drift('SDTEMPO3', 0.35000, 'DriftPass');
