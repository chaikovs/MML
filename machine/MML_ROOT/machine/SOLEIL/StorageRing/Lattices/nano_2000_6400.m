function varargout = nano_2000_6400
...
% Octobre 2010 - S11 added S12 set to 0 close to Q12
...
LQC = 0.180100E+00*2;
LQL = 0.248100E+00*2;
Q1   =  quadrupole('Q1' , LQC,  -0.1066163E+01, 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,   0.1600701E+01, 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -0.6449315E+00, 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -0.1258681E+01 , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,   0.1694322E+01 , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -0.1004861E+01, 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,   0.2083827E+01 , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  -0.1548929E+01, 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -0.1498343E+01 , 'QuadLinearPass');
Q10  =  quadrupole('Q10', LQC,   0.1753578E+01 , 'QuadLinearPass');
Q11  =  quadrupole('Q11', LQC,  -0.1797987E+01, 'QuadLinearPass');
Q12  =  quadrupole('Q12', LQL,   0.1775149E+01, 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  0.3438380*F*5, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv, -0.8020912*F*5, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv, -0.4338700*F*5, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  0.7209300*F*5, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv, -0.7396420*F*5, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  0.6493340*F*5, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv, -1.0007040*F*5, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  0.8387440*F*5, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv, -0.7606068*F*5, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  0.4475698*F*5, 'StrMPoleSymplectic4Pass');
S11 =  sextupole('S11', Finv,  0.3438380*F*5, 'StrMPoleSymplectic4Pass');
S12 =  sextupole('S12', Finv,  0.0000000*F*5, 'StrMPoleSymplectic4Pass');
...
SUP3  = [  ...
    ...
    SDC1 FCOR  SDC2   BPM     SDNSC1 Q11 SDNSC2 Q12 SX12];
%    SDC1 FCOR  SDC2   BPM     SD1e  ];
