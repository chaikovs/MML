function varargout = lat_pseudo_nanoscopium_juin2011_122BPM 
...
S1  =  sextupole('S1' , Finv,  0.343838*5*F, SPassMethod);
S2  =  sextupole('S2' , Finv, -0.6283534*5*F, SPassMethod);
S3  =  sextupole('S3' , Finv, -0.4724375*5*F, SPassMethod);
S4  =  sextupole('S4' , Finv,  0.8128982*5*F, SPassMethod);
S5  =  sextupole('S5' , Finv, -0.755816*5*F,  SPassMethod);
S6  =  sextupole('S6' , Finv,  0.6088501*5*F, SPassMethod);
S7  =  sextupole('S7' , Finv, -1.030959*5*F,  SPassMethod);
S8  =  sextupole('S8' , Finv,  0.8083523*5*F, SPassMethod);
S9  =  sextupole('S9' , Finv, -0.7188769*5*F, SPassMethod);
S10 =  sextupole('S10', Finv,  0.4461458*5*F, SPassMethod);
S11 =  sextupole('S11', Finv,  0.343838*5*F,  SPassMethod);
...
SD12u= drift('SD12', 0.2, 'DriftPass'); % upstream H-scraper % TO BE UPDATED
SD12d= drift('SD12', 0.44990-0.2, 'DriftPass'); % downstream internal H-scraper
