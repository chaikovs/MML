function varargout = lat_2020_3170e 
...
Q1   =  quadrupole('Q1' , LQC,  -0.1217526E+01, 'StrMPoleSymplectic4Pass');
Q2   =  quadrupole('Q2' , LQL,   0.1674972E+01, 'StrMPoleSymplectic4Pass');
Q3   =  quadrupole('Q3' , LQC,  -0.5308946E+00, 'StrMPoleSymplectic4Pass');
Q4   =  quadrupole('Q4' , LQC,  -0.1268515E+01, 'StrMPoleSymplectic4Pass');
Q5   =  quadrupole('Q5' , LQC,   0.1709814E+01, 'StrMPoleSymplectic4Pass');
Q6   =  quadrupole('Q6' , LQC,  -0.1090209E+01, 'StrMPoleSymplectic4Pass');
Q7   =  quadrupole('Q7' , LQL,   0.2031731E+01, 'StrMPoleSymplectic4Pass');
Q8   =  quadrupole('Q8' , LQC,  -0.1417185E+01, 'StrMPoleSymplectic4Pass');
Q9   =  quadrupole('Q9' , LQC,  -0.147801E+01,  'StrMPoleSymplectic4Pass');
Q10  =  quadrupole('Q10', LQC,   0.1744141E+01, 'StrMPoleSymplectic4Pass');
...
S9  =  sextupole('S9' , Finv, -0.7247067*5*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  0.4110236*5*F, 'StrMPoleSymplectic4Pass');
...
SDL09  = [SD1e SD1e]; 
%SDL13  = [SD1e BPM BPM SD1e]; % NANOSCOPIUM U20 + TOMOGRAPHY U18 CRYO
