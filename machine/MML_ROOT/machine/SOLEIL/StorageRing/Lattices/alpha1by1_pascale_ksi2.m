...
SDC22= drift('SDC22',0.311  , 'DriftPass');
...
de=1-4e-3*0;
Q1   =  quadrupole('Q1' , 0.32,  -.1438063E+01*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , 0.46,   0.1793668E+01*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , 0.32,  -.5760102E+00*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , 0.32,  -.1134870E+01*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , 0.32,   0.1821778E+01*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , 0.32,  -.1800474E+01*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , 0.46,   0.2030671E+01*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , 0.32,  -.4048428E+00*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , 0.32,  -.1337932E+01*de , 'QuadLinearPass');
Q10  =  quadrupole('Q10', 0.32,   0.1878525E+01*de , 'QuadLinearPass');
