...
SD2 = drift('SD2',  0.37305, 'DriftPass');
SD3 = drift('SD3',   0.184150, 'DriftPass');
%SD4 = drift('SD4',  0.39000, 'DriftPass');
%SD14= drift('SD14', 0.59000, 'DriftPass');
SD5 = drift('SD5',  0.18305, 'DriftPass');
SD6 = drift('SD6',  0.79000, 'DriftPass');
SD7 = drift('SD7',  0.42305, 'DriftPass');
SD8 = drift('SD8',  0.18305, 'DriftPass');
%SD9 = drift('SD9',  0.47634, 'DriftPass');
%SD10= drift('SD10', 0.47000, 'DriftPass');
SD12= drift('SD12', 0.453050, 'DriftPass');
%SDAC= drift('SDAC', 1.90468, 'DriftPass');

% SD existantes et modifiees
SD1d = drift('SD1d',  0.5170, 'DriftPass');
SD14a = drift('SD14a', 0.38815, 'DriftPass');
SD9a = drift('SD9a',  0.20735	, 'DriftPass');
SD10a = drift('SD10a', 0.17545	, 'DriftPass');
...
SD91 = drift('SD91',  0.25439, 'DriftPass');
SD41 = drift('SD41',  0.2521, 'DriftPass');
SD42 = drift('SD42',  0.205, 'DriftPass');
SD92 = drift('SD92',  0.20745, 'DriftPass');
SD93 = drift('SD93',  0.25445	, 'DriftPass');
SD43 = drift('SD43', 0.2051	, 'DriftPass');
%SD101 = drift('SD101', 0.2394, 'DriftPass');
SD141 = drift('SD141', 0.43505, 'DriftPass');

SDB1 = drift('SDB1',  0.29415, 'DriftPass');
SDB2 = drift('SDB2', 0.169050, 'DriftPass');
SDB3 = drift('SDB3', 0.252,  'DriftPass');
SDB4 = drift('SDB4', 0.2776 ,'DriftPass');
SDB5 = drift('SDB5', 0.205  ,'DriftPass');
SDB6 = drift('SDB6', 0.122050 ,'DriftPass');
SDB7 = drift('SDB7', 0.169150 , 'DriftPass');
SDB8 = drift('SDB8', 0.252 , 'DriftPass');
SDB9 = drift('SDB9', 0.12205 ,'DriftPass');
SDB10= drift('SDB10',0.169150 , 'DriftPass');
SDB11= drift('SDB11',0.2519, 'DriftPass');
SDB12= drift('SDB12',0.2049, 'DriftPass');
SDB13= drift('SDB13',0.122050, 'DriftPass');
SDB14= drift('SDB14',0.169050, 'DriftPass');
SDB15= drift('SDB15',0.252 , 'DriftPass');
%SDB16= drift('SDB16',0.2306 , 'DriftPass');
SDB17= drift('SDB17',0.205 , 'DriftPass');
SDB18= drift('SDB18',0.12215 , 'DriftPass');

SDC1 = drift('SDC1' , 0.24505 ,  'DriftPass');
...
SDC8 = drift('SDC8' , 0.24505 ,  'DriftPass');
SDC9 = drift('SDC9' , 0.079  , 'DriftPass');
SDC10= drift('SDC10',0.07845, 'DriftPass');
SDC11= drift('SDC11',0.24505  , 'DriftPass');
...
SDC16= drift('SDC16',0.24505  , 'DriftPass');
SDC17= drift('SDC17',0.079  , 'DriftPass');
SDC18= drift('SDC18',0.07845, 'DriftPass');
SDC19= drift('SDC19',0.24505  , 'DriftPass');
SDC20= drift('SDC20',0.24505  , 'DriftPass');
SDC21= drift('SDC21',0.079  , 'DriftPass');
SDC22= drift('SDC22',0.29405  , 'DriftPass');
...
LQC = 0.1769500E+00 * 2 ;
LQL = 0.2458500E+00 * 2 ;
Q1   =  quadrupole('Q1' , LQC,  -.1314331E+01*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,   0.1691719E+01*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -.5237922E+00*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -.1036652E+01*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,   0.1657556E+01*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -.1641010E+01*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,   0.1914204E+01*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  -.3708910E+00*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -.1219500E+01*de , 'QuadLinearPass');
Q10  =  quadrupole('Q10', LQC,   0.1708234E+01*de , 'QuadLinearPass');
