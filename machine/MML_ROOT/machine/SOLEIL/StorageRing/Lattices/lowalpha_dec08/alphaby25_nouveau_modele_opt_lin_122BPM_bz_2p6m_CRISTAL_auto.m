...
Q1   =  quadrupole('Q1' , LQC,  -.7055035E+00 , QPassMethod);
Q2   =  quadrupole('Q2' , LQL,   0.1489957E+01 , QPassMethod);
Q3   =  quadrupole('Q3' , LQC,  -.9591250E+00 , QPassMethod);
Q4   =  quadrupole('Q4' , LQC,  -.9916917E+00 , QPassMethod);
Q5   =  quadrupole('Q5' , LQC,   0.1680703E+01 , QPassMethod);
Q6   =  quadrupole('Q6' , LQC,  -.1420295E+01 , QPassMethod);
Q7   =  quadrupole('Q7' , LQL,   0.9600863E+00 , QPassMethod);
Q8   =  quadrupole('Q8' , LQC,  0.9858248E+00 , QPassMethod);
Q9   =  quadrupole('Q9' , LQC,  -.1281630E+01 , QPassMethod);
Q10  =  quadrupole('Q10', LQC,   0.1811261E+01 , QPassMethod);
...
S1  =  sextupole('S1' , Finv,  -0.4076408*F, SPassMethod);
S2  =  sextupole('S2' , Finv,  -1.768677*F, SPassMethod);
S3  =  sextupole('S3' , Finv,  -3.893281*F, SPassMethod);
S4  =  sextupole('S4' , Finv,  4.541016*F, SPassMethod);
S5  =  sextupole('S5' , Finv,  -2.277198*F, SPassMethod);
S6  =  sextupole('S6' , Finv,  2.608039*F, SPassMethod);
S7  =  sextupole('S7' , Finv,  -2.000000*F, SPassMethod);
S8  =  sextupole('S8' , Finv,  2.238338*F, SPassMethod);
S9  =  sextupole('S9' , Finv,  -3.700070*F, SPassMethod);
S10  =  sextupole('S10' , Finv,  4.400000*F, SPassMethod);
S11 =  sextupole('S11', Finv,  -0.4076408*F,  SPassMethod);
...
% set short section CRISTAL upstream and downstream for betaz=2.6m
THERING = setbzCRISTAL(THERING,ATIndexList);
...
function THERING= setbzCRISTAL(THERING,ATIndexList)

QP6N = -2.0024;% valeurs pour ne pas depasser 249A ; %-.2013219E+01; valeurs theoriques
QP7N =  0.1522704E+01;
QP8N = 0.4006584E+00;
QP9N = -.2369292E+00;
QP10N = 0.1604836E+01;
THERING = setquad(THERING, ATIndexList.Q6(8), QP6N);
THERING = setquad(THERING, ATIndexList.Q6(9), QP6N);
THERING = setquad(THERING, ATIndexList.Q7(8), QP7N);
THERING = setquad(THERING, ATIndexList.Q7(9), QP7N);
THERING = setquad(THERING, ATIndexList.Q8(8), QP8N);
THERING = setquad(THERING, ATIndexList.Q8(9), QP8N);
THERING = setquad(THERING, ATIndexList.Q9(5), QP9N);
THERING = setquad(THERING, ATIndexList.Q9(6), QP9N);
THERING = setquad(THERING, ATIndexList.Q10(5), QP10N);
THERING = setquad(THERING, ATIndexList.Q10(6), QP10N);
