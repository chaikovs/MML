...
LQC = 0.180100E+00 * 2 ;
LQL = 0.248100E+00 * 2 ;
Q1   =  quadrupole('Q1' , LQC,  -0.708389*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,  1.491083*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -0.955248*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -0.997158*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,  1.681512*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -1.429536*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,  1.021737*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  0.919365*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -1.290037*de , 'QuadLinearPass');
Q10   =  quadrupole('Q10' , LQC,  1.813949*de , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  -0.509553*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv,  -1.700000*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv,  -3.792045*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  4.500000*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv,  -2.177159*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  2.392069*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv,  -2.000000*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  2.163955*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv,  -3.692072*F, 'StrMPoleSymplectic4Pass');
