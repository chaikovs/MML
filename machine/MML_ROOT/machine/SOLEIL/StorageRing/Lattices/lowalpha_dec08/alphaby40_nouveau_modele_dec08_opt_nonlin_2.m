...
LQC = 0.180100E+00 * 2 ;
LQL = 0.248100E+00 * 2 ;
Q1   =  quadrupole('Q1' , LQC,  -0.714360*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,  1.494215*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -0.954075*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -0.995146*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,  1.681635*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -1.422656*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,  0.990775*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  0.953468*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -1.286725*de , 'QuadLinearPass');
Q10   =  quadrupole('Q10' , LQC,  1.814227*de , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  -0.562813*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv,  -1.700000*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv,  -3.795344*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  4.500000*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv,  -2.208730*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  2.420624*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv,  -2.000000*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  2.150919*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv,  -3.636994*F, 'StrMPoleSymplectic4Pass');
