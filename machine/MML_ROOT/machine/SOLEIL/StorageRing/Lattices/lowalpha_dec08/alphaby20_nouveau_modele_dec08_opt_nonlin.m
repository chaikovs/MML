...
LQC = 0.180100E+00 * 2 ;
LQL = 0.248100E+00 * 2 ;
Q1   =  quadrupole('Q1' , LQC,  -0.713136*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,  1.489257*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -0.939403*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -0.997221*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,  1.680586*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -1.448414*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,  1.078610*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  0.855988*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -1.288733*de , 'QuadLinearPass');
Q10   =  quadrupole('Q10' , LQC,  1.812300*de , 'QuadLinearPass');
