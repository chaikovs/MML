...
CAV = rfcavity('RF' , 0 , 2.8e+6 , HarmNumber*C0/L0, ...
    HarmNumber ,'CavityPass');
...
LQC = 0.180100E+00 * 2 ;
LQL = 0.248100E+00 * 2 ;
Q1   =  quadrupole('Q1' , LQC,  -0.714609*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,  1.494509*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -0.955201*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -0.993042*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,  1.681611*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -1.415107*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,  0.959827*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  0.986990*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -1.284080*de , 'QuadLinearPass');
Q10   =  quadrupole('Q10' , LQC,  1.814629*de , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  -0.495218*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv,  -1.700000*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv,  -3.858231*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  4.500000*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv,  -2.280381*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  2.438860*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv,  -2.000000*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  2.208606*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv,  -3.608800*F, 'StrMPoleSymplectic4Pass');
