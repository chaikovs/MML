...
CAV = rfcavity('RF' , 0.0 , 3.2e+6 , HarmNumber*C0/L0, HarmNumber ,'CavityPass');
...
Q5   =  quadrupole('Q5' , LQC,   1.6928611E+00 , QPassMethod);
Q6   =  quadrupole('Q6' , LQC,  -.1471161E+01 , QPassMethod);
Q7   =  quadrupole('Q7' , LQL,   1.199276E+00 , QPassMethod);
Q8   =  quadrupole('Q8' , LQC,  0.7021245E+00 , QPassMethod);
Q9   =  quadrupole('Q9' , LQC,  -.1301369E+01 , QPassMethod);
Q10  =  quadrupole('Q10', LQC,   1.82074E+00 , QPassMethod);
...
SDAC1a = drift('SDAC1a', 0.48428	, 'DriftPass'); % upstream SDC - U20 entrance 
SDAC1b = drift('SDAC1b', 1.0	, 'DriftPass'); % U20 exit - downstream SDC
...
SDC06 = [SDAC1a SDAC1b SDAC1b SDAC1a];% CRISTAL U20
