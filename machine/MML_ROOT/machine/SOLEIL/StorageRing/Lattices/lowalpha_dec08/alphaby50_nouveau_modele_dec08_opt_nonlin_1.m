...
LQC = 0.180100E+00 * 2 ;
LQL = 0.248100E+00 * 2 ;
Q1   =  quadrupole('Q1' , LQC,  -0.715576*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,  1.494852*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -0.953999*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -0.994236*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,  1.681719*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -1.418255*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,  0.973203*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  0.972500*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -1.285392*de , 'QuadLinearPass');
Q10   =  quadrupole('Q10' , LQC,  1.814499*de , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  -0.521949*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv,  -1.700000*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv,  -3.848730*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  4.500000*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv,  -2.271919*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  2.430758*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv,  -2.000000*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  2.182227*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv,  -3.604537*F, 'StrMPoleSymplectic4Pass');
