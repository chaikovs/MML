...
LQC = 0.180100E+00 * 2 ;
LQL = 0.248100E+00 * 2 ;
Q1   =  quadrupole('Q1' , LQC,  -.7729734E+00*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,   0.1527832E+01*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -.9516947E+00*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -.9794584E+00*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,   0.1685867E+01*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -.1237167E+01*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,   0.04559420E+01*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC,  .1440869E+01*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC,  -.1261555E+01*de , 'QuadLinearPass');
Q10  =  quadrupole('Q10', LQC,   0.1821190E+01*de , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  0.03933541*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv,  -1.563275*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv,  -4.104795*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  5.6*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv,  -2.280280*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  2.465097*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv,  -2.001529*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  2.292831*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv,  -4.172604*F, 'StrMPoleSymplectic4Pass');
S10  =  sextupole('S10' , Finv,  4.775652*F, 'StrMPoleSymplectic4Pass');
S11  =  sextupole('S11' , Finv,  0.03933541*F, 'StrMPoleSymplectic4Pass');
