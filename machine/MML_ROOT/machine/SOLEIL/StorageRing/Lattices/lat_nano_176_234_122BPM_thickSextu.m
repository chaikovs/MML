function varargout = lat_nano_176_234_122BPM_thickSextu 
...
%% SCRAPER
HSCRAP =  aperture('HSCRAP', [-0.035, 0.035, -0.05, 0.05],'AperturePass');
VSCRAP =  marker('VSCRAP', 'IdentityPass');
mSDC15 = aperture('mSDC15', [-0.030, 0.035, -0.05, 0.05],'AperturePass');
...
S1  =  sextupole('S1' , Lsextu,  0.281*5*Finv, SPassMethod); 
S2  =  sextupole('S2' , Lsextu, -0.654*5*Finv, SPassMethod);
S3  =  sextupole('S3' , Lsextu, -0.338*5*Finv, SPassMethod);
S4  =  sextupole('S4' , Lsextu,  0.697*5*Finv, SPassMethod);
S5  =  sextupole('S5' , Lsextu, -0.714*5*Finv, SPassMethod);
S6  =  sextupole('S6' , Lsextu,  0.667*5*Finv, SPassMethod);
S7  =  sextupole('S7' , Lsextu, -0.992*5*Finv, SPassMethod);
S8  =  sextupole('S8' , Lsextu,  0.778*5*Finv, SPassMethod);
S9  =  sextupole('S9' , Lsextu, -0.8434*5*Finv, SPassMethod);
S10 =  sextupole('S10', Lsextu,  0.5063*5*Finv, SPassMethod);
S11 =  sextupole('S11', Lsextu,  0.242*5*Finv, SPassMethod);
S12 =  sextupole('S12', Lsextu,  1.000E-10*Finv, SPassMethod); % to be drawn by drawlattice

%S1  =  sextupole('S1' , Lsextu,  1.5461*Finv, SPassMethod); %SDC 7 mai 2012
%S9  =  sextupole('S9' , Lsextu, -3.9214*Finv, SPassMethod); %SDC 7 mai 2012
%S10 =  sextupole('S10', Lsextu,  2.3583*Finv, SPassMethod); %SDC 7 mai 2012
%S11 =  sextupole('S11', Lsextu,  1.202*Finv, SPassMethod); %SDC 7 mai 2012

Lsextu = .016/2;
%% Skew quadrupoles
SQPassMethod = 'StrMPoleSymplectic4Pass';
QT    =  skewquad('SkewQuad', 1e-8, 0.0, SQPassMethod);
QTPX2 =  skewquad('QTPX2', 1e-10, 0.0, SQPassMethod); % PX2
...
%BEND=[BEND1  BEND2 BEND3 BEND2 BEND4];
BEND  =  rbend2('BEND', 1.05243, theta, thetae, thetas, K,fullgap,'BndMPoleSymplectic4Pass');
