...
LQC = 0.180100E+00*2;
LQL = 0.248100E+00*2;
Q1   =  quadrupole('Q1' , LQC,  -0.1160155E+01, 'QuadLinearPass');
Q2   =  quadrupole('Q2' , LQL,   0.1685354E+01, 'QuadLinearPass');
Q3   =  quadrupole('Q3' , LQC,  -0.6945082E+00, 'QuadLinearPass');
Q4   =  quadrupole('Q4' , LQC,  -0.1208482E+01, 'QuadLinearPass');
Q5   =  quadrupole('Q5' , LQC,   0.1699720E+01, 'QuadLinearPass');
Q6   =  quadrupole('Q6' , LQC,  -0.1175045E+01, 'QuadLinearPass');
Q7   =  quadrupole('Q7' , LQL,  0.2019414E+01, 'QuadLinearPass');
Q8   =  quadrupole('Q8' , LQC, -0.1328200E+01, 'QuadLinearPass');
Q9   =  quadrupole('Q9' , LQC, -0.1383039E+01, 'QuadLinearPass');
Q10  =  quadrupole('Q10', LQC,  0.1736806E+01, 'QuadLinearPass');
Q11  =  quadrupole('Q11', LQC, -0.1700926E+01, 'QuadLinearPass');
Q12  =  quadrupole('Q12', LQL,  0.1700188E+01, 'QuadLinearPass');
