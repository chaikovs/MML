...
Q1   =  quadrupole('Q1' , LQC, -1.074062, QPassMethod);
Q2   =  quadrupole('Q2' , LQL,  1.631254, QPassMethod);
Q3   =  quadrupole('Q3' , LQC, -0.6329217,QPassMethod);
Q4   =  quadrupole('Q4' , LQC, -1.327183, QPassMethod);
Q5   =  quadrupole('Q5' , LQC,  1.731278, QPassMethod);
Q6   =  quadrupole('Q6' , LQC, -0.9851412, QPassMethod);
Q7   =  quadrupole('Q7' , LQL,  1.904923, QPassMethod);
Q8   =  quadrupole('Q8' , LQC, -1.126787, QPassMethod);
Q9   =  quadrupole('Q9' , LQC, -1.667109, QPassMethod);
Q10  =  quadrupole('Q10', LQC,  1.790258, QPassMethod);
...
S1  =  sextupole('S1' , Finv,  0.2290969*5*F, SPassMethod);
S2  =  sextupole('S2' , Finv, -0.5041105*5*F, SPassMethod);
S3  =  sextupole('S3' , Finv, -0.4768036*5*F, SPassMethod);
S4  =  sextupole('S4' , Finv,  0.6779787*5*F, SPassMethod);
S5  =  sextupole('S5' , Finv, -0.8009117*5*F, SPassMethod);
S6  =  sextupole('S6' , Finv,  0.7316421*5*F, SPassMethod);
S7  =  sextupole('S7' , Finv, -0.9622986*5*F, SPassMethod);
S8  =  sextupole('S8' , Finv,  0.9125886*5*F, SPassMethod);
S9  =  sextupole('S9' , Finv, -0.5327715*5*F, SPassMethod);
S10 =  sextupole('S10', Finv,  0.3275514*5*F, SPassMethod);
S11 =  sextupole('S11', Finv,  0.2290969*5*F, SPassMethod);
