...
switch AcceleratorName
    case 'LT1'
        ...
        switch upper(deblank(MagnetCoreType))
            ...
            case 'BEND'
                Leff = 0.30; % 300 mm
                % B = 1e-4 * (0.0004 Ie + 16.334 I + 1.7202)
                a8 =  0.0;
                a7 =  0.0;
                a6 =  0.0;
                a5 =  0.0;
    ...
    case 'StorageRing'
        ...
        switch upper(deblank(MagnetCoreType))
            ...
            case 'BEND'
                ...
                % Décalage en champ entre le dipele de référence et les
                % dipeles de l'Anneau = DB/B= +1.8e-03.
                % On part de l'etalonnage B(I) effectue sur le dipele de
                % reference dans la zone de courant 516 - 558 A
                % les coefficients du fit doivent etre affectes du facteur
                % (1-1.8e-3) pour passer du dipele de reference e l'Anneau
                % et du facteur Leff pour passer e l'integrale de champ.
                %

                % B=1.7063474 T correspond e 2.75 GeV
            ...
            case 'QT'    % 160 mm dans sextupole
                % Etalonnage: moyenne sur les 32 sextupeles incluant un QT.
            ...
            case {'HCOR'}    % 16 cm horizontal corrector
                % Etalonnage: moyenne sur les 56 sextupeles incluant un CORH.
            ...
            case {'VCOR'}    % 16 cm vertical corrector
                % Etalonnage: moyenne sur les 56 sextupeles incluant un CORV.
