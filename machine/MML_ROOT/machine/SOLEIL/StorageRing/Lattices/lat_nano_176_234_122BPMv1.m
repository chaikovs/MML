function varargout = lat_nano_176_234_122BPMv1 
...
% (200 um larger)
% July 2013 v1 add multipole for correctors
...
%% Multipole at the same location of slow correctors
HMulCorr =  multipole('HMulCorr',1e-18, 0.0, 0.0,'StrMPoleSymplectic4Pass');
VMulCorr =  multipole('VMulCorr',1e-18, 0.0, 0.0,'StrMPoleSymplectic4Pass');
...
SX1   = [S1  COR  QT HMulCorr VMulCorr];
SX2   = [S2  COR  QT HMulCorr VMulCorr];
SX3   = [S3  COR  QT HMulCorr VMulCorr];
SX4   = [S4  COR  QT HMulCorr VMulCorr];
SX5   = [S5  COR  QT HMulCorr VMulCorr];
SX6   = [S6  COR  QT HMulCorr VMulCorr];
SX7   = [S7  COR  QT HMulCorr VMulCorr];
SX8   = [S8  COR  QT HMulCorr VMulCorr];
SX9   = [S9  COR  QT HMulCorr VMulCorr];
SX10  = [S10 COR  QT HMulCorr VMulCorr];
SX11  = [S11 COR  QT HMulCorr VMulCorr];
SX12  = [S12 COR  QT HMulCorr VMulCorr];
% SX1   = [S1  COR  QT];
% SX2   = [S2  COR  QT];
% SX3   = [S3  COR  QT];
% SX4   = [S4  COR  QT];
