function varargout = lat_nano_176_234_122BPM 
% 2013-08-23 nanoscopium + waist U24 PX2 avec betaz min = 1.1 m 
...
HarmNumber = 416;
U0 = 929e3 ; % perte par tour sans onduleur � 2.739 GeV
...
Q7   =  quadrupole('Q7' , LQL,  0.2016457E+01, QPassMethod);
Q8   =  quadrupole('Q8' , LQC, -0.1324658E+01, QPassMethod);
Q9   =  quadrupole('Q9' , LQC, -0.1368981E+01, QPassMethod);
...
QP8m1 = -0.1481773E+01;
QP9m1 = -0.7471808E+00;
QP10m1 = 0.1635737E+01;
QP6m2 = -1.396364E+00;
QP7m2 = 0.2136275E+01;
QP8m2 = -0.1546605E+01;
QP9m2 = -0.1342441E+01;
QP10m2 = 0.1678285E+01;
THERING = setquad(THERING, ATIndexList.Q10(10), QP10m1);
THERING = setquad(THERING, ATIndexList.Q10(11), QP10m2);
THERING = setquad(THERING, ATIndexList.Q9(10), QP9m1);
THERING = setquad(THERING, ATIndexList.Q9(11), QP9m2);
THERING = setquad(THERING, ATIndexList.Q8(15), QP8m1);
THERING = setquad(THERING, ATIndexList.Q8(16), QP8m2);
THERING = setquad(THERING, ATIndexList.Q7(15), QP7m1);
THERING = setquad(THERING, ATIndexList.Q7(16), QP7m2);
THERING = setquad(THERING, ATIndexList.Q6(15), QP6m1);
THERING = setquad(THERING, ATIndexList.Q6(16), QP6m2);
