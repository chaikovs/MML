function varargout = alpha1by20_maher
...
Q1   =  quadrupole('Q1' , 0.32,   -0.8235568, 'QuadLinearPass');
Q2   =  quadrupole('Q2' , 0.46,    1.603015, 'QuadLinearPass');
Q3   =  quadrupole('Q3' , 0.32,   -1.014789, 'QuadLinearPass');
Q4   =  quadrupole('Q4' , 0.32,   -1.144827, 'QuadLinearPass');
Q5   =  quadrupole('Q5' , 0.32,    1.889275, 'QuadLinearPass');
Q6   =  quadrupole('Q6' , 0.32,   -1.593784, 'QuadLinearPass');
Q7   =  quadrupole('Q7' , 0.46,    1.170552, 'QuadLinearPass');
Q8   =  quadrupole('Q8' , 0.32,    0.9353995, 'QuadLinearPass');
Q9   =  quadrupole('Q9' , 0.32,   -1.473743, 'QuadLinearPass');
Q10  =  quadrupole('Q10', 0.32,    2.032442, 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv, -0.6364920*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv, -1.700000*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv, -3.861550*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  4.500000*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv, -2.319760*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  2.515790*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv, -2.00000*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  2.188280*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv, -3.609380*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  4.40000*F, 'StrMPoleSymplectic4Pass');
