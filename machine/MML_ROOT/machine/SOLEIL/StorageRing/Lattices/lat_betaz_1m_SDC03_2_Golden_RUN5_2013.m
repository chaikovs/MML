function varargout = lat_betaz_1m_SDC03_Golden_RUN5_2013

% Nanoscopium Golden RUN5 2013 + betaz = 1m dans SDC03 + betax = 18 m +
% etax = 0.22 m, pour réduire effet sur emittance H
% PBrunelle Septembre 2015
...
Q1   =  quadrupole('Q1' , LQC, -1.204467e+00, QPassMethod);
Q2   =  quadrupole('Q2' , LQL,  1.688035e+00, QPassMethod);
Q3   =  quadrupole('Q3' , LQC, -6.379707e-01, QPassMethod);
Q4   =  quadrupole('Q4' , LQC, -1.228083e+00, QPassMethod);
Q5   =  quadrupole('Q5' , LQC,  1.713381e+00, QPassMethod);
Q6   =  quadrupole('Q6' , LQC, -1.171245e+00, QPassMethod);
Q7   =  quadrupole('Q7' , LQL,  2.02063e+00, QPassMethod);
Q8   =  quadrupole('Q8' , LQC, -1.310686e+00, QPassMethod);
Q9   =  quadrupole('Q9' , LQC, -1.352722e+00, QPassMethod);
Q10  =  quadrupole('Q10', LQC,  1.733143e+00, QPassMethod);
...
S1  =  sextupole('S1' , Finv,  0.301*5*F, SPassMethod);
...
S9  =  sextupole('S9' , Finv, -0.781*5*F, SPassMethod);
S10 =  sextupole('S10', Finv,  0.487*5*F, SPassMethod);
...
%BEND  =  rbend2('BEND', 1.05243, theta, thetae, thetas, K,fullgap,'BndMPoleSymplectic4Pass');
 ...
 BEND1  =  rbend2('BEND', 1.05243*3.8/11.25, theta*3.8/11.25, thetae, 0, K,fullgap,'BndMPoleSymplectic4Pass');
 BEND2  =  rbend2('BEND', 1.05243*(11.25-2*3.8)/11.25, theta*(11.25-2*3.8)/11.25, 0, 0, K,fullgap,'BndMPoleSymplectic4Pass');
 BEND3  =  rbend2('BEND', 1.05243*3.8/11.25, theta*3.8/11.25, 0, thetas, K,fullgap,'BndMPoleSymplectic4Pass');
...
QW9  = -1.756130;
QW10 =  1.798993;
THERING = setquad(THERING, ATIndexList.Q8(3), QW81);
THERING = setquad(THERING, ATIndexList.Q8(6), QW81);

THERING = setquad(THERING, ATIndexList.Q8(4), QW8);
THERING = setquad(THERING, ATIndexList.Q8(5), QW8);

THERING = setquad(THERING, ATIndexList.Q7(4), QW7);
THERING = setquad(THERING, ATIndexList.Q7(5), QW7);

THERING = setquad(THERING, ATIndexList.Q6(4), QW6);
THERING = setquad(THERING, ATIndexList.Q6(5), QW6);

THERING = setquad(THERING, ATIndexList.Q9(3), QW9);
THERING = setquad(THERING, ATIndexList.Q9(4), QW9);

THERING = setquad(THERING, ATIndexList.Q10(3), QW10);
THERING = setquad(THERING, ATIndexList.Q10(4), QW10);
