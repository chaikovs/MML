...
% 7 mai 2009 - P. Brunelle - Spoles anneau - introduction des coefficents d�duits de
% l'�talonnage en courant utilisant les vraies valeurs des courants + r�partition par intervalle de courant.

% 12 juin 2009 - P. Brunelle - Qpoles anneau - r�partition par intervalle de courant.
...
%                 MagnetType = 'quad';
            ...
            case {'Q6SDC'}
                ...
                a4=  0.0;
                a3=  0.0;
                a2=  -1.51646E-4*(-1)*(1.003)*bob;
                a1=  9.16800E-2*(1.003)*bob;
                a0=  -6.82533*(-1)*(1.003)*bob;
                A = [a7 a6 a5 a4 a3 a2 a1 a0];
                MagnetType = 'quad';     

            case {'Q8SDC'}
                % CAS DU QUADRUPOLE COURT DONT LE COURANT EST COMPRIS ENTRE 50 et 100A
                % POLARITE - mais gradient +
                Leff=LtotQC;
                a7=  0.0;
                a6=  0.0;
                a5=  0.0;
                a4=  0.0;
                a3=  0.0;
                a2=  -1.78428E-7*(1.003)*bob;
                a1=  2.75663E-2*(-1)*(1.003)*bob;
                a0=  1.90367E-2*(1.003)*bob;
                A = [a7 a6 a5 a4 a3 a2 a1 a0];
                MagnetType = 'quad';
...
%                 MagnetType = 'quad';
 ...
 % SEXTUPOLES : on multiplie les coefficients par 2 car ils sont exprimes en B"L et non B"L/2
            ...
            case{'S1', 'S11'}
                ...
                % POLARITE (courant) + mais H - car alimentation sextupole "retourn�e"
                Leff=LtotSX;
                a7=  0.0;
                a6=  0.0;
                a5=  0.0;
