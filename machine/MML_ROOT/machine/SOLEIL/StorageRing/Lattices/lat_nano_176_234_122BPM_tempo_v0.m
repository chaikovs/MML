function varargout = lat_nano_176_234_122BPM_tempo_sym
...
L0 = 3.540970204203007e+02;% design length [m]
...
%% TEMPO Chicane
CHITEMPO =  corrector('CHITEMPO',0.0,[0 0],'CorrectorPass');
...
% TEMPO straight section
SDTEMPO1 = drift('SDTEMPO1', 0.53455, 'DriftPass');
SDTEMPO2 = drift('SDTEMPO2', 0.30000, 'DriftPass');
SDTEMPO3 = drift('SDTEMPO3', 1.01600, 'DriftPass');
%SDTEMPO4 = drift('SDTEMPO4', 1.74900-9.8e-5, 'DriftPass'); %Length of HU44 or HU80
SDTEMPO4 = drift('SDTEMPO4', 1.74900-9.8e-5-0.30000, 'DriftPass'); %Length of HU44 or HU80 increase space between chicane
SDTEMPO5 = drift('SDTEMPO5', 0.10000, 'DriftPass');
SDTEMPO6 = drift('SDTEMPO6', 0.30000, 'DriftPass');
SDTEMPO7 = drift('SDTEMPO7', 0.53455, 'DriftPass');
...
SDM06 = [SD13a PUMA SD13a]; % PUMA future Wiggler
%SDM06 = [SDWSV50 SWSV50 SDWSV50]; % PUMA future Wiggler
SDM07 = [SD13a SD13a]; % DEIMOS HU52+EMPHU65
%SDM08 = [SD13a SD13a]; % TEMPO HU80+HU44
% asymetric
SDM08 = [SDTEMPO1 CHITEMPO SDTEMPO2 CHITEMPO SDTEMPO3 SDTEMPO4 SDTEMPO4 ...
    SDTEMPO5 CHITEMPO SDTEMPO6 CHITEMPO SDTEMPO7]; % TEMPO HU80+HU44 + chicane
% symetric
SDM08 = [SDTEMPO1 CHITEMPO SDTEMPO2 SDTEMPO2 CHITEMPO SDTEMPO3 SDTEMPO4 SDTEMPO4 ...
    SDTEMPO5 CHITEMPO SDTEMPO6 SDTEMPO6 CHITEMPO SDTEMPO7]; % TEMPO HU80+HU44 + chicane
