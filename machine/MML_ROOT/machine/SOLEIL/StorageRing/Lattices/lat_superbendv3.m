function varargout = lat_superbendv3 
%
% C---------------------------------------------------------------------
...
HALFSUPERPERIOD = [CELLML CELLS];
SUPERPERIOD = [HALFSUPERPERIOD reverse(HALFSUPERPERIOD)];

%THE STORAGE RING
ELIST = [...
    SUPERPERIOD SUPERPERIOD SUPERPERIOD SUPERPERIOD ...
    CAV];
