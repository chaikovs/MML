...
% PathAndFileNameRefStart=['/home/production/matlab/matlabML/measdata/Ringdata/insertions/HU640_DESIRS/' SESSION  '/DataInMatlabFormat/' FileNameRefStart];
% PathAndFileNameRefEnd=['/home/production/matlab/matlabML/measdata/Ringdata/insertions/HU640_DESIRS/' SESSION  '/DataInMatlabFormat/' FileNameRefEnd];
% PathAndFileName=['/home/production/matlab/matlabML/measdata/Ringdata/insertions/HU640_DESIRS/' SESSION  '/DataInMatlabFormat/' FileName];
IDDirName_ = getfamilydata('Directory', 'insertions');
PathAndFileNameRefStart=[IDDirName_ 'HU640_DESIRS/' SESSION  '/DataInMatlabFormat/' FileNameRefStart];
PathAndFileNameRefEnd  =[IDDirName_ 'HU640_DESIRS/' SESSION  '/DataInMatlabFormat/' FileNameRefEnd];
PathAndFileName        =[IDDirName_ 'HU640_DESIRS/' SESSION  'DataInMatlabFormat/' FileName];
