...
%%PARAMETRES
    ...
    % REGLER LA VITESSE DE GAP A 4mm/s ET PHASE A 1mm/s 
        ...
        Und_phase = [-40.2,-36:4:36,40.2];
        %Und_gap = [15.5,16:2:20,22.5:2.5:27.5,30:5:40,50:10:100,125:25:225,239];
        Und_gap = [15.5,16:2:20,22.5:2.5:27.5,30:5:40,50:10:100,125,140,239];
    % REDIGER ELOG
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%CALIBRATION DES CORRECTEURS
     [structureAllFileNames, res] = idMeasCorEfficForAllGaps(UndName, '', 10, Und_gap, 1);
...
%%CODs
        % LANCER LE MODE PARALLELE: MODE 0
            ...
            % CORRECTION D'ORBITE
            Und_ModeName = 'II1'
            Und_MeasName = strcat('CODs_',Und_ModeName);
            [resFiles, resErr] = idMeasElecBeamVsUndParam(Und_Name, {{'phase', Und_phase, 0.01}, {'gap', Und_gap, 0.01}}, {{'phase', 0, 0.01}, {'gap', 239.5, 0.01}}, 1, 0, Und_MeasName, 1);
        ...
        % LANCER LE MODE ANTIPARALLELE: MODE 1
            ...
            [mCHE, mCVE, mCHS, mCVS] = idCalcFeedForwardCorTables(Und_Name, {{'phase', Und_phase}, {'gap', Und_gap}}, resFiles.filenames_meas_bkg, '', '', -1)
            %Prendre le nom du fichier summary
            CalcFFWDTables(Und_Name,Und_FileName,'CODs_X1_summary_2012-11-03_hh-mm-ss.mat',Und_MeasName,1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
