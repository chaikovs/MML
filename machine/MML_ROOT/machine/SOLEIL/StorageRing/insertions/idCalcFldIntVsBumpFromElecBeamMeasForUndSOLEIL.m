function [vI1x, vI2x, vI1z, vI2z, vPosBump, vKickX1, vKickX2, vKickZ1, vKickZ2, dNuX, dNuZ] = idCalcFldIntVsBumpFromElecBeamMeasForUndSOLEIL(idName, dirMeasData, fileNamesBumpInf, undParam, dirModel, arIndsBPMsToSkip, vKick2x_rad, vKick2z_rad)
...
for i = 1:numBumps
    ...
    [vI1x(i), vI2x(i), vI1z(i), vI2z(i)] = idCalcFldIntFromElecBeamMeas(ElecBeamMeasMain, ElecBeamMeasBkgr, mCODx, mCODz, arAbsIndsBPMsToSkip, GeomParUnd.idLen, GeomParUnd.idKickOfst, ElecBeamModelData.E, vKick2x_rad(i), vKick2z_rad(i), vR0x, vR0z);
