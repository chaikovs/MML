function IdQuickCorCalibInVac(UndName,DeviceServerName,CurMin,CurMax)
...
% Example: IdQuickCorCalibInVac('U24_PROXIMA2','ANS-C11/EI/M-U24',-6,6)
%          IdQuickCorCalibInVac('U20_GALAXIES','ANS-C07/EI/C-U20',-6,6)
%          IdQuickCorCalibInVac('WSV50_PSICHE','ANS-C03/EI/C-WSV50',-6,6)
%          IdQuickCorCalibInVac('U20_NANO','ANS-C13/EI/L-U20.2',-6,6)
%          IdQuickCorCalibInVac('U18_TOMO','ANS-C13/EI/L-U18.1',-6,6)
%          IdQuickCorCalibInVac('W164_PUMA_SLICING','ANS-C06/EI/M-W164',-6,6)
