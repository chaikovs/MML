...
[arElecBeamMeasCHE, arElecBeamMeasBkgrCHE, vCurValsCHE] = HU640_ReadCorElecBeamMeasData(idName, gap, 'CHE');
[arElecBeamMeasCVE, arElecBeamMeasBkgrCVE, vCurValsCVE] = HU640_ReadCorElecBeamMeasData(idName, gap, 'CVE');
[arElecBeamMeasCHS, arElecBeamMeasBkgrCHS, vCurValsCHS] = HU640_ReadCorElecBeamMeasData(idName, gap, 'CHS');
[arElecBeamMeasCVS, arElecBeamMeasBkgrCVS, vCurValsCVS] = HU640_ReadCorElecBeamMeasData(idName, gap, 'CVS');
