...
numLoopsWaitRes = 2; %% valeur originale 300
sleepTime = 3; %[s]
sleepTimeFin = 7; %[s]
...
if useAppleIIDServerLevel1
    ...
    elseif (strcmp(attrName, 'phase') || strcmp(attrName, 'PHASE'))
        ...
        tango_command_inout2(idSetUndParamSyncDServName, 'GotoPhase', [real(attrValue), multMode*real(attrValue)]);
    end
else 
