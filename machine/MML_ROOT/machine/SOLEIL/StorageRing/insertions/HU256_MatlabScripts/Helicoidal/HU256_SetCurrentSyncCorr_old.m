function res = HU256_SetCurrentSyncCorr(MainCurrentToSet, MainCurrentAbsTol, Bxc1CurrentToSet, Bzc1CurrentToSet, Bxc28CurrentToSet, Bzc27CurrentToSet)
%Avant modif : function res = HU256_SetCurrentSyncCorr(MainCurrentToSet, MainCurrentAbsTol, Bzc1CurrentToSet, Bzc27CurrentToSet, Bxc1CurrentToSet, Bxc28CurrentToSet)
...
if (isa(APERIODIC, 'numeric')==1)
    ...
    if (strcmp(POWERSUPPLYNAME, 'bz')==1)
        idDevServ=[HU256Cell '/EI/m-HU256.2_BZP'];
        if (TESTWITHOUTPS==1)
            fprintf('BZP -> %3.3f\tBX -> %3.3f\tBzc1 -> %3.3f\tBzc4 -> %3.3f\tBxc1 -> %3.3f\tBxc4 -> %3.3f\n', PRESENTCURRENT, BXPRESENTCURRENTFORHEL, Bzc1CurrentToSet, Bzc27CurrentToSet, Bxc1CurrentToSet, Bxc28CurrentToSet)
        else %TESTWITHOUTPS=0
            idCorrDevServ=[HU256Cell '/ei/m-hu256.2_shim.'];
            ...
            writeattribute(attrBzmCurrent5, 0);
            writeattribute(attrBzmCurrent6, 0);
            writeattribute(attrBz/home/operateur/GrpGMI/HU256_PLEIADES/SESSION_2007_04_27/Correction_LHmCurrent7, 0);
            writeattribute(attrBzmCurrent8, 0);
