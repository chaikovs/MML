function res=HU256_Tab_OperationWith2Tables (Operation, FullNameOfScriptTable1_Or_Number, FullNameOfScriptTable2, FullNameOfSumScriptTable)
    ...
    if (isa(FullNameOfScriptTable1_Or_Number, 'char')~=1)
        ...
        Matrix1=HU256_Tab_GetMatrixFromTable(FullNameOfScriptTable1_Or_Number, 0);  % NOT CIRCULAR
        Matrix2=HU256_Tab_GetMatrixFromTable(FullNameOfScriptTable2, 0);            % NOT CIRCULAR
%           Matrix1=HU256_Tab_GetMatrixFromTable_modif_pour_hel_up(FullName
%           OfScriptTable1_Or_Number, 0);   % CIRCULAR
%           Matrix2=HU256_Tab_GetMatrixFromTable_modif_pour_hel_up(FullName
%           OfScriptTable2, 0);   % CIRCULAR
        if (Matrix1==-1)
