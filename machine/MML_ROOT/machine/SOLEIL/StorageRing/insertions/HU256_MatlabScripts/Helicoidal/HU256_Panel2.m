...
%% Figure & Panels creations
    ...
    HU256PANELHANDLES.CassiopeeButton=uicontrol(HU256PANELHANDLES.CellGrp, 'Style', 'radiobutton', 'SelectionHighlight', 'off', 'String', 'Cassiopée', 'Units', 'pixels', 'Position', [10 70 70 30]);
    HU256PANELHANDLES.PleiadesButton=uicontrol(HU256PANELHANDLES.CellGrp, 'Style', 'radiobutton', 'SelectionHighlight', 'off', 'String', 'Pléiades', 'Units', 'pixels', 'Position', [10 40 70 30]);
    HU256PANELHANDLES.AntaresButton=uicontrol(HU256PANELHANDLES.CellGrp, 'Style', 'radiobutton', 'SelectionHighlight', 'off', 'String', 'Antarès', 'Units', 'pixels', 'Position', [10 10 70 30]);
...
%     HU256_CorrectionDirectoryTextClick(HU256PANELHANDLES.CorrectionDirectoryText, eventdata)
