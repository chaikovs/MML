function res=HU256_GoOnCycling(MainPowerSupplyName, NameOfTableToUseForCorrection, OrbitsAcquisitionDirectory, NameOfTableToBuild, DispCorrTable )
    ...
    debug=0;
    %ListOfZCurrents=[-200:200:200];    % pas de 200 : 3 points pour essai
    ...
    %ListOfXCurrents=horzcat([0:275:275]);       % pas de 125 : 4 points pour essai
    ListOfXCurrents=[0:12.5:275];       % pas de 12.5 : très précis
...
% Orbits Acquisition
    if (strcmp(OrbitsAcquisitionDirectory, '')==0)
      ...
      FileNameCore=['HU256_CASSIOPEE_' upper(POWERSUPPLYNAME) '_' strrep(num2str(PRESENTCURRENT),'.','_') '_' StringSenseOfCurrent];
