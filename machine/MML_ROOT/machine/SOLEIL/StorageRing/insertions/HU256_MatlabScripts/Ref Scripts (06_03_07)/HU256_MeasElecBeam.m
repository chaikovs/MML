...
CurrentBzc1=readattribute('ans-c15/ei/m-hu256.2-shim.1/current1');
CurrentBzc27=readattribute('ans-c15/ei/m-hu256.2-shim.1/current4');
CurrentBxc1=readattribute('ans-c15/ei/m-hu256.2-shim.2/current1');
CurrentBxc28=readattribute('ans-c15/ei/m-hu256.2-shim.2/current4');
StateBzc=tango_command_inout2('ans-c15/ei/m-hu256.2-shim.1', 'State');
StateBxc=tango_command_inout2('ans-c15/ei/m-hu256.2-shim.2', 'State');
...
if dispData ~= 0
    ...
    fprintf('Bzc1 = %07.3f A (%s)\tBxc1 = %07.3f A (%s)\n', CurrentBzc1, StateBzc, CurrentBxc1, StateBxc)
    fprintf('Bzc27 = %07.3f A (%s)\tBxc28 = %07.3f A (%s)\n', CurrentBzc27, StateBzc, CurrentBxc28, StateBxc)
end
