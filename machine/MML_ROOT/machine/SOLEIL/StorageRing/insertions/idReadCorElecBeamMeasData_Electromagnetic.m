...
%% HU256 PLEIADES
    elseif (strcmp(idName, 'HU256_PLEIADES'))
        ...
        if strcmp(corName, 'CHE')
			vCurVals = [-2, -1, 0, 1, 2];
			fnMeasMain = cellstr([  'Calibration_HU256_PLEIADES_he-2_ve0_hs0_vs0_2016-09-12_10-36-10.mat';
                                    'Calibration_HU256_PLEIADES_he-1_ve0_hs0_vs0_2016-09-12_10-36-32.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-36-54.mat ';
                                    'Calibration_HU256_PLEIADES_he1_ve0_hs0_vs0_2016-09-12_10-37-16.mat ';
                                    'Calibration_HU256_PLEIADES_he2_ve0_hs0_vs0_2016-09-12_10-37-40.mat ']);
			fnMeasBkgr = cellstr([  'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-38-04.mat ';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-38-04.mat ';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-38-04.mat ';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-38-04.mat ';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-38-04.mat ']);
		elseif strcmp(corName, 'CHS')
			vCurVals = [-2, -1, 0, 1, 2];
			fnMeasMain = cellstr([	'Calibration_HU256_PLEIADES_he0_ve0_hs-2_vs0_2016-09-12_10-40-47.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs-1_vs0_2016-09-12_10-41-08.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-41-30.mat ';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs1_vs0_2016-09-12_10-41-53.mat ';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs2_vs0_2016-09-12_10-42-14.mat ']);
			fnMeasBkgr = cellstr([	'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-42-38.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-42-38.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-42-38.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-42-38.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-42-38.mat']);
		elseif strcmp(corName, 'CVE')
			vCurVals = [-2, -1, 0, 1, 2];
			fnMeasMain = cellstr([	'Calibration_HU256_PLEIADES_he0_ve-2_hs0_vs0_2016-09-12_10-38-28.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve-1_hs0_vs0_2016-09-12_10-38-50.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-39-13.mat ';
                                    'Calibration_HU256_PLEIADES_he0_ve1_hs0_vs0_2016-09-12_10-39-36.mat ';
                                    'Calibration_HU256_PLEIADES_he0_ve2_hs0_vs0_2016-09-12_10-39-59.mat ']);
			fnMeasBkgr = cellstr([	'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-40-24.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-40-24.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-40-24.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-40-24.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-40-24.mat';]);
		elseif strcmp(corName, 'CVS')
			vCurVals = [-2, -1, 0, 1, 2];
			fnMeasMain = cellstr([	'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs-2_2016-09-12_10-43-02.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs-1_2016-09-12_10-43-22.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-43-44.mat ';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs1_2016-09-12_10-44-07.mat ';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs2_2016-09-12_10-44-29.mat ']);
			fnMeasBkgr = cellstr([	'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-44-52.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-44-52.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-44-52.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-44-52.mat';
                                    'Calibration_HU256_PLEIADES_he0_ve0_hs0_vs0_2016-09-12_10-44-52.mat']);
        end
