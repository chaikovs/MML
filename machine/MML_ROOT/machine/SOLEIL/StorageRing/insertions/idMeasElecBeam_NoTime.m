function outStructElecBeam = idMeasElecBeam_NoTime(inStructElecBeam, inclPerturbMeas, dispData)
...
try
    ...
    lasterror('reset');
    print 'Failure in getx or getz; trying again...';
	outStructElecBeam = idMeasElecBeam_NoTime(inStructElecBeam, inclPerturbMeas, dispData);
    return;
end
