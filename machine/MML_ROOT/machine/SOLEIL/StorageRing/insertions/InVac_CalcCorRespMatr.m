...
% Modified by Fabien on December 4th 2006: the correctors current values are
% not an argument of the function anymore. See idCalcCorRespMatr_old in
% case of problem!

[arElecBeamMeasCHE, arElecBeamMeasBkgrCHE, vCurValsCHE] = idReadCorElecBeamMeasDataPlanar(idName, gap, 'CHE');
[arElecBeamMeasCVE, arElecBeamMeasBkgrCVE, vCurValsCVE] = idReadCorElecBeamMeasDataPlanar(idName, gap, 'CVE');
[arElecBeamMeasCHS, arElecBeamMeasBkgrCHS, vCurValsCHS] = idReadCorElecBeamMeasDataPlanar(idName, gap, 'CHS');
[arElecBeamMeasCVS, arElecBeamMeasBkgrCVS, vCurValsCVS] = idReadCorElecBeamMeasDataPlanar(idName, gap, 'CVS');
