...
%the matrix m_with_arg keeps the argument values
...
if(length(vOldArg1) == 1)
    mNew = interp1(vOldArg2', mOld, vNewArg2, interpMeth);
elseif(length(vOldArg2) == 1)
    mNew = interp1(vOldArg1, mOld, vNewArg1', interpMeth);
else
