function outStructElecBeam = idMeasElecBeamNoTime(inStructElecBeam, inclPerturbMeas, dispData)
...
try
	...
	outStructElecBeam = idMeasElecBeamNoTime(inStructElecBeam, inclPerturbMeas, dispData);
    return;
end
