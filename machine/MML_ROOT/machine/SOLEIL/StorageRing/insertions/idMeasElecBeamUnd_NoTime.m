function outStruct = idMeasElecBeamUnd_NoTime(idName, inclPerturbMeas, fileNameCore, dispData)
%idMeasElecBeamUnd
%
%  INPUTS
...
outStruct = idMeasElecBeam_NoTime(outStruct, inclPerturbMeas, dispData);
...
if strcmp(fileNameCore, '') == 0
    outStruct.file = idSaveStruct_NoTime(outStruct, fileNameCore, idName, dispData);
end
