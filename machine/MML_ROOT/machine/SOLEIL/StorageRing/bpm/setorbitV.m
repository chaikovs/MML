function OCS = setorbitV(varargin)
%SETORBITV - Correct the horizontal orbit
%
%  INPUTS
...
% switchard for typical orbit correction at SOLEIL
switch TypeFlag
    case 'FOFB'
...
Zgoal = getgolden(BPMFamily, BPMlist);
