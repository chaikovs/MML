...
%  July 1st, 2007 Added New Flag SummaryFlag to sort BPM by STD by descreasing values
...
% for refreshing BPM data TANGO issue
getx; getz;
...
switch getmode('BPMx')
    case 'Online'
        tango_giveInformationMessage('Fin de mesure de bruit BPM');
end
