function [LocoMeasData, BPMData, CMData, RINGData, FitParameters, LocoFlags] = buildlocoinput_fofb(OutputFileName, GuessIt)
%BUILDLOCOINPUT_FOFB - Matlab Middlelayer (MML) method for building a LOCO input file.
