...
% Last Modified by GUIDE v2.5 28-Apr-2017 02:05:24
...
% --- Executes on button press in pushbutton_FBcoupling.
function pushbutton_FBcoupling_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_FBcoupling (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --------------------------------------------------------------------
function Which_Lattice_Callback(hObject, eventdata, handles)
% hObject    handle to Which_Lattice (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Test_which_lattice
