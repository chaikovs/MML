...
%         end
    ...
    case 'SetupcouplingFB'
        ...
        if InitFlag % just at startup
            ...
            couplingFB.minDeltaEz = deltaK * Ex0 * rapportPHC ;
            ...
            deltaK = 0.6e-2;
            couplingFB.maxDeltaEz = deltaK * Ex0 * rapportPHC ;
            ...
            deltaK = 5e-3;
            couplingFB.EzErrorMax = deltaK * Ex0 * rapportPHC ;
...
switch get(get(hObject,'SelectedObject'),'Tag')  % Get Tag of selected object
    ...
    case 'radiobutton2'
        ...
        fac_betaz   = 0.9 ; % attention ajustement pour avoir la meme taille verticale à la pHC1 qu'avec le FBcoupling PHC1....
        rapportPHC  = (37/50) * fac_betaz ; % POUR L'AFFICHAGE SEULEMENT rapport des émittances de réference pour 50 pmrad à PHC1, en pmrad (just to write on interface)
