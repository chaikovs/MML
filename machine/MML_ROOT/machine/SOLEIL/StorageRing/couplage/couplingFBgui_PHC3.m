...
devemit = 'ANS-C16/DG/PHC-EMIT';
devImA = 'ANS-C16/DG/PHC-IMAGEANALYZER';
temp = tango_read_attribute2('ANS/FC/PUB-SLICING','isSlicing')
isSlicing = temp.value(1) ;
isPHC3 = 1 ;

fac_beta = 0.9 ; % attention ajustement pour avoir la meme taille verticale à la pHC1 qu'avec le FBcoupling PHC1....
betaz = readattribute([devemit '/BetaZ']) * fac_beta ;  
%%%MXphc1  = 5.691/4.360 ;
...
MXphc1  = DistPinholeV2Convert / DistSource2PinholeV ;
rapportPHC3_PHC1 = (37/50) * fac_beta ; % POUR L'AFFICHAGE SEULEMENT rapport des émittances de réference pour 50 pmrad à PHC1, en pmrad (just to write on interface)
    ...
    case 'Initialize'
        ...
        elseif isPHC3
            uicontrol('Parent',h0, ...
                ...
                'ListboxTop',0, ...
                'Position',[LeftMargin 3 + Frame1top - 1.5*(ButtonHeight+3) FrameWidth .6*ButtonHeight], ...
                'String','Coupling Feedback with PHC3', ...
                'Style','text');
        else
            uicontrol('Parent',h0, ...
                'BackgroundColor',v, ...
...
%             'Tag','couplingFBguiCheckboxVcorrection');
        ...
        uicontrol('Parent',h0, ...
            'Callback','couplingFBgui_PHC3(''StartcouplingFB'');', ...
            'BackgroundColor',v, ...
            'Enable','on', ...
            'FontSize',10, ...
            'FontWeight', 'Bold', ...
        ...
        uicontrol('Parent',h0, ...
            'Callback','couplingFBgui_PHC3(''StopcouplingFB'');', ...
            'BackgroundColor',v, ...
            'Enable','on', ...
            'FontSize',10, ...
            'FontWeight', 'Bold', ...
        ...
        uicontrol('Parent',h0, ...
            'Callback','couplingFBgui_PHC3(''CurrentThresholdSetting'');', ...
            'BackgroundColor',v, ...
        ...
        uicontrol('Parent',h0, ...
            'Callback','couplingFBgui_PHC3(''QTList'');', ...
            'BackgroundColor',v, ...
            'ForegroundColor',[1 0 0], ...
            'Enable','on', ...
            'FontSize',10, ...
...
% 'BackgroundColor',[0.8 0.8 0.8], ...
        uicontrol('Parent',h0, ...
            'CreateFcn','couplingFBgui_PHC3(''SetupcouplingFB'',1);', ...
            'Callback','couplingFBgui_PHC3(''SetupcouplingFB'');', ...
            'BackgroundColor',v, ...
            'FontSize',10, ...
            'FontWeight', 'Bold', ...
            'ListboxTop',0, ...
...
% 'String','To get Status Push button: ', ...
        ...
        uicontrol('Parent',h0, ...
            'callback','couplingFBgui_PHC3(''UpdateStatuscouplingFB'');pause(0);', ...
            'BackgroundColor',v, ...
            'HorizontalAlignment','center', ...
            'ListboxTop',0, ...
...
%             'Tag','couplingFBguiiscouplingzFBRunning');
   ...
   %         'Position',[FrameLeft 8 1.1*FrameWidth 0.7*Frame0height], ...
    %        'Style','frame');
        ...
        uicontrol('Parent',h0, ...
            'Callback','couplingFBgui_PHC3(''ApplyGoldenQT'');', ...
            'ForegroundColor',[1 0 0], ...
            'Enable','On', ...
            'Interruptible','Off', ...
...
%                 tuneFB.Golden.tune(2) = 0.3100;
            ...
            couplingFB.minDeltaEz = deltaK * Ex0 *rapportPHC3_PHC1 ;
            ...
            deltaK = 0.6e-2;
            couplingFB.maxDeltaEz = deltaK * Ex0 *rapportPHC3_PHC1;
            ...
            deltaK = 5e-3;
            couplingFB.EzErrorMax = deltaK * Ex0 *rapportPHC3_PHC1;
