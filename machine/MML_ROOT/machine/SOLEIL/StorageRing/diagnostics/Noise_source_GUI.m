function varargout = Noise_source_GUI(varargin)
% NOISE_SOURCE_GUI M-file for Noise_source_GUI.fig
%      NOISE_SOURCE_GUI, by itself, creates a new NOISE_SOURCE_GUI or raises the existing
%      singleton*.
%
%      H = NOISE_SOURCE_GUI returns the handle to a new NOISE_SOURCE_GUI or the handle to
%      the existing singleton*.
%
%      NOISE_SOURCE_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NOISE_SOURCE_GUI.M with the given input arguments.
%
%      NOISE_SOURCE_GUI('Property','Value',...) creates a new NOISE_SOURCE_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Noise_source_GUI_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Noise_source_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Noise_source_GUI

% Last Modified by GUIDE v2.5 20-Feb-2012 11:05:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Noise_source_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @Noise_source_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Noise_source_GUI is made visible.
function Noise_source_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Noise_source_GUI (see VARARGIN)

% Choose default command line output for Noise_source_GUI
...
% UIWAIT makes Noise_source_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Noise_source_GUI_OutputFcn(hObject, eventdata, handles) 
