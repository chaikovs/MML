...
set(w,'SelectedObject',w1);  % No selection
set(w,'Visible','on');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if strcmp(get(hObject,'Visible'),'off')
    ...
    if strcmp(handles.mode,'Model')
        ...
        [X Z Sum] = anabpmnfirstturns( BPMx.DeviceList ,1,7,'NoDisplay', 'NoDisplay2','MaxSum');
    ...
    if strcmp(handles.mode,'Model')
        ...
        [X Y Sum] = anabpmnfirstturns(BPMxDeviceListPR,2,'NoDisplay2', 'NoDisplay');   % 2 tours
...
if enregistrement
    if strcmp(handles.orbite,'transport - max Sum')
        ...
        %Name = 'Maher_alphaover20_5nov07_Meff';
        Name = 'AMOR_alphaover10_10dec10_Meff';
    ...
    if strcmp(handles.orbite,'transport - max Sum')
        directory = getfamilydata('Directory','Steerette');
        Name = 'Maher_alphaover20_5nov07_Meff'  ;% 'solamor2linb_new_13mai_Meff';
