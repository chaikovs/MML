...
% setorbitdefault - Basic orbit correction for SOLEIL storage ring
%
%  OPTIONAL INPUTS
%  'Display' {'NoDisplay'}
%  'Struct'
%  'x' or 'h' or 'Horizontal'
%  'y' or 'z' or 'v' or 'vertical'
...
for i = length(varargin):-1:1
    ...
    elseif strcmpi(varargin{i},'NoDisplay')
        DisplayFlag = 'NoDisplay';
        varargin(i) = [];
    elseif any(strcmpi(varargin{i},{'x', 'h', 'Horizontal'}))
        PlaneFlag = 1;
        varargin(i) = [];
    elseif any(strcmpi(varargin{i},{'y', 'z', 'v', 'Vertical'}))
        PlaneFlag = 2;
        varargin(i) = [];
    end
end
