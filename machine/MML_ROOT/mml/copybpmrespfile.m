...
if exist([DirectoryName, FileName],'file')
    ...
    if ~ErrorFlag
        copyfile([DirectoryName, FileName], [BackupDirectoryName, BackupDataFileName]);
        ...
        copyfile([DirectoryName, FileName], [DirectoryName, BackupDataFileName]);
    end
    cd(DirStart);
end
...
% Do the copy
copyfile([DataDirectoryName, DataFileName], [DirectoryName, FileName]);
