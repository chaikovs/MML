...
%     (energy is in GeV)
%
%  See also getenergy, getmcf

%
%  Written by James Safranek, Moohyun Yoon, Greg Portmann (SPEAR3)
%  Modified by Laurent S. Nadolski
%  09/02/06 exact computation using kinetic energy correction
...
% Exact formula is mandatory for low energy like in transfert lines
E0 = PhysConstant.electron_mass_energy_equivalent_in_MeV.value*1e-3;  %electron rest mass in GeV
%brho = (10/2.99792458) * sqrt(Energy.^2 - E0.^2);
% WARNING AT and other tracking code give kinetic energy and not total
% energy
%brho = (10/2.99792458) * sqrt((Energy+E0).^2 - E0.^2);
brho = sqrt((Energy+E0).^2 - E0.^2)/(PhysConstant.speed_of_light_in_vacuum.value*1e-9);
