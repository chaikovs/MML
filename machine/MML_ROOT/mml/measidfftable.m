...
%FFGETTBL - Measures an insertion device feed forward table for the vertical gap 
...
%      removed quad generation option from routine - tune compensation is handled by orbit feedback algorithm now
%
...
fprintf('            Figure ', num2str(FigureHandles(1)),'  ->  Corrector strength verses gap position.');
fprintf('            Figure ', num2str(FigureHandles(2)),'  ->  RMS orbit distortion verses gap position.');
fprintf('                                                   ->  Orbit drift during table generation verses BPM position.');
fprintf('            Figure ', num2str(FigureHandles(3)),'  ->  Rate of Change of the Corrector Magnets.');
