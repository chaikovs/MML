function [LocoMeasData, BPMData, CMData, RINGData, FitParameters, LocoFlags] = buildlocoinput_thomx(OutputFileName)
...
switch ButtonName,
    case 'Get From File'
        ...
        Rmat(1,1) = getrespmat(BPMxFamily, [], HCMFamily, [], [BPMRespDirectory BPMRespFile], 'Struct', 'Hardware', 'NoEnergyScaling');%, 'NoEnergyScaling'
        Rmat(1,2) = getrespmat(BPMxFamily, [], VCMFamily, [], [BPMRespDirectory BPMRespFile], 'Struct', 'Hardware', 'NoEnergyScaling');%, 'NoEnergyScaling'
        Rmat(2,1) = getrespmat(BPMyFamily, [], HCMFamily, [], [BPMRespDirectory BPMRespFile], 'Struct', 'Hardware', 'NoEnergyScaling');%, 'NoEnergyScaling'
        Rmat(2,2) = getrespmat(BPMyFamily, [], VCMFamily, [], [BPMRespDirectory BPMRespFile], 'Struct', 'Hardware', 'NoEnergyScaling');%, 'NoEnergyScaling'
...
LocoFlags.HorizontalDispersionWeight = 1;%12.5;
LocoFlags.VerticalDispersionWeight = 1;%12.5;
