...
%
% k = 0;
% setsp('Q1',k* DK(1) + K1i_before, Mode,'Physics');
% setsp('Q2',k* DK(2) + K2i_before, Mode,'Physics');
% setsp('Q3',k* DK(3) + K3i_before, Mode,'Physics');
% setsp('Q4',k* DK(4) + K4i_before, Mode,'Physics');
% setsp('Q5',k* DK(5) + K5i_before, Mode,'Physics');
% setsp('Q6',k* DK(6) + K6i_before, Mode,'Physics');
% setsp('Q7',k* DK(7) + K7i_before, Mode,'Physics');
% setsp('Q8',k* DK(8) + K8i_before, Mode,'Physics');
% setsp('Q9',k* DK(9) + K9i_before, Mode,'Physics');
% setsp('Q10',k* DK(10) + K10i_before, Mode,'Physics');
% %modelbeta
