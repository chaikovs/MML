function [LocoMeasData, BPMData, CMData, RINGData, FitParameters, LocoFlags] = buildlocofitparameters_thomx(FileName)
...
ModeCell = {'Fit by family', 'Fit magnets by power supply', 'Fit selected quads','Fit by magnet'};
