...
if PlotFlag
    ...
    subplot(2,1,1);
    if ~isempty(X)
        errorbar(X(:,5), X(:,3), X(:,4), '.b', 'Markersize', 13);
    end
    ...
    subplot(2,1,2);
    if ~isempty(Y)
        errorbar(Y(:,5), Y(:,3), Y(:,4), '.b', 'Markersize', 13);
    end
    ...
    subplot(2,1,1);
    if ~isempty(X)
        plot(X(:,5), GoodIndexX,'.', 'Markersize', 13);
    end
    ...
    subplot(2,1,2);
    if ~isempty(Y)
        plot(Y(:,5), GoodIndexY,'.', 'Markersize', 13);
    end
    xlabel('BPM Position [meters]');
    ...
    subplot(2,1,1);
    if ~isempty(X)
        plot(X(:,5), CorrDeltaX,'.', 'Markersize', 13);
    end
    ...
    subplot(2,1,2);
    if ~isempty(Y)
        plot(Y(:,5), CorrDeltaY,'.', 'Markersize', 13);
    end
    xlabel('BPM Position [meters]');
    ...
    subplot(2,1,1);
    if ~isempty(X)
        plot(X(:,5), QuadDeltaX,'.', 'Markersize', 13);
    end
    ylabel('Horizontal corrector current (A)');
    xaxis([0 L]);
    ...
    subplot(2,1,2);
    if ~isempty(Y)
        plot(Y(:,5), QuadDeltaY,'.', 'Markersize', 13);
    end
    xlabel('BPM Position [meters]');
    ylabel('Vertical corrector current (A)');
    xaxis([0 L]);
    ...
    subplot(2,1,1);
    if ~isempty(X)
        plot(X(:,5), OutlierFactorX,'.', 'Markersize', 13);
    end
    ...
    subplot(2,1,2);
    if ~isempty(Y)
        plot(Y(:,5), OutlierFactorY,'.', 'Markersize', 13);
    end
    xlabel('BPM Position [meters]');
    ...
    subplot(2,1,1);
    if ~isempty(X)
        plot(X(:,5), MaxTuneX,'.', 'Markersize', 13);
    end
    ...
    subplot(2,1,2);
    if ~isempty(Y)
        plot(Y(:,5), MaxTuneY,'.', 'Markersize', 13);
    end
    xlabel('BPM Position [meters]');
    ...
    subplot(2,1,1);
    if ~isempty(X)
        plot(X(:,5), MaxQuadOrbitVariationX,'.', 'Markersize', 13);
    end
    ylabel('H-BBA: X (mm)');
    xaxis([0 L]);
    ...
    subplot(2,1,2);
    if ~isempty(Y)
        plot(Y(:,5), MaxQuadOrbitVariationY,'.', 'Markersize', 13);
    end
    xlabel('BPM Position [meters]');
    ylabel('V-BBA: : Z (mm)');
    xaxis([0 L]);
    ...
    subplot(2,1,1);
    if ~isempty(X)
        plot(X(:,5), MaxCorrOrbitVariationX,'.', 'Markersize', 13);
    end
    ylabel('H-BBA: X (mm)');
    xaxis([0 L]);
    ...
    subplot(2,1,2);
    if ~isempty(Y)
        plot(Y(:,5), MaxCorrOrbitVariationY,'.', 'Markersize', 13);
    end
    xlabel('BPM Position [meters]');
    ylabel('V-BBA: : Z (mm)');
    xaxis([0 L]);
