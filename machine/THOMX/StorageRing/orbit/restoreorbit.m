...
%corz
%FileName = ['/Users/ichaikov/Documents/MATLAB/SVN/mm_thomx/MML/machine/THOMX/StorageRing/orbit/', FileName];
...
%% HU640 obsolete
%temp = getbpmresp('BPMx', 'BPMz', 'HCOR', 'VCOR', [getfamilydata('Directory','BPMResponse') 'BPMRespMat_HU640.mat'],'struct');
%% end HU640
