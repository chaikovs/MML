function varargout = TDR_017_064_r56_02_Dff412_sxfit2
%************************************************************
...
QP1 = quadrupole('QP1', LQP, -.4861690E+01, QPassMethod);
QP2 = quadrupole('QP2', LQP, 0.9441459E+01, QPassMethod);
QP3 = quadrupole('QP3', LQP, -.1854283E+02, QPassMethod);
QP4 = quadrupole('QP4', LQP, 0.1646009E+02, QPassMethod);
QP31 = quadrupole('QP31', LQP, -.8900146E+01, QPassMethod);
QP41 = quadrupole('QP41', LQP,  0.5107448E+01, QPassMethod);
...
%  SX3 = sextupole('SX3', LSX, -.3289547E+01/LSX*sx_on, SPassMethod); 
 ...
 SX1 = sextupole('SX1', 0.1000000E-05, -651136.2*sx_on,  SPassMethod); 
 SX2 = sextupole('SX2', 0.1000000E-05,  -8502849.2193908 *sx_on, SPassMethod); 
 SX3 = sextupole('SX3', 0.1000000E-05,  2879612.87804732 *sx_on, SPassMethod);
