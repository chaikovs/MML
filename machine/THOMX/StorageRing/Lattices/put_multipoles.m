...
ring = TDR_017_064_r56_02_Dff412_chro11;
...
% ring_quadFF =atsetfieldvalues(rerr,find(atgetcells(rerr,'Class','Quadrupole')),...
%     'PassMethod','QuadMPoleFringePass' );


%atwritem(rerr, '/Users/ichaikov/Documents/MATLAB/MML_v1/machine/THOMX/StorageRing/Lattices/ThomX_017_064_r56_02_chro11_multip.m')

%%

ring = ThomX_017_064_r56_02_chro11;
rerr = ThomX_017_064_r56_02_chro11_multip;

[XX,ZZ]   = atdynap(ring, 500,0,0.02); 
[XX_mp,ZZ_mp]   = atdynap(rerr, 500,0,0.02); 
%[XX_quadFF,ZZ_quadFF]   = atdynap(ring_quadFF, 500,0,0.02); 
...
%plot(XX_quadFF,ZZ_quadFF,'r*-','MarkerSize',10,'LineWidth',2,'DisplayName', 'QUAD FF MULTIP');
plot(XX,ZZ,'bo-','MarkerSize',7,'DisplayName', ['DA in AT: SEXT  Chro ' num2str(c_mp)]); %,'HandleVisibility','off'
plot(XX_mp,ZZ_mp,'mo-','MarkerSize',7,'LineWidth',2,'DisplayName', ['DA in AT: QUAD/SEXT MULTIPOLES Chro ' num2str(c_mp)]); %,'HandleVisibility','off'
xlabel('x [m]')
ylabel('z [m]')
set(gca,'FontSize',20)
set(gcf,'color','w')
