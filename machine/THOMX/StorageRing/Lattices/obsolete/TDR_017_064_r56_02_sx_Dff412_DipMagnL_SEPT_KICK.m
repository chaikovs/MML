function varargout = TDR_017_064_r56_02_sx_Dff412_DipMagnL_SEPT_KICK
%************************************************************
...
%************************************************************
 ...
 L0 =  17.986715999999991;%17.986715999999987;%17.986692; % design circumference length [m]; 
...
SD31Bkick = drift('SD31Bkick', 0.36E+00, 'DriftPass');
SD31Akick = drift('SD31Akick', 0.39375E+00 - dL, 'DriftPass');
...
str1K = [SD5B BPMx BPMz SD5 QP1 SD2 QP2 SD31Bkick KICKER SD31Akick];
...
str2K = [SD31Akick KICKER SD31Bkick QP2 SD2 QP1 SD5 BPMx BPMz SD5B];

%ELIST =[DEBUT RF str1 cell1 cell2 str2 SEPT str1 cell1 IP cell2 str2 FIN];
ELIST =[DEBUT RF str1 cell1 cell2 str2K SEPT str1K cell1 IP cell2 str2 FIN];
