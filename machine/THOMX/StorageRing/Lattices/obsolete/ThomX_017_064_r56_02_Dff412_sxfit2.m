function ring=ThomX_017_064_r56_02_Dff412_sxfit2()
ring={...
       atmarker('DEBUT');...
       atmarker('SEPT');...
   ...
   atquadrupole('QP2',0.15731,9.441459,'StrMPoleSymplectic4Pass','Energy',50000000);...
    ...
    atsextupole('SX1',1e-06,-651136.2,'Energy',50000000);...
   ...
   atquadrupole('QP31',0.15731,-8.900146,'StrMPoleSymplectic4Pass','Energy',50000000);...
        atdrift('SD3S',0.071345,'Energy',50000000);...
    atsextupole('SX3',1e-06,2879612.87804732,'Energy',50000000);...
    atcorrector('HCOR',1e-06,[0 0],'PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
    atcorrector('VCOR',1e-06,[0 0],'PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
   ...
   atquadrupole('QP41',0.15731,5.107448,'StrMPoleSymplectic4Pass','Energy',50000000);...
    ...
    atsextupole('SX2',1e-06,-8502849.2193908,'Energy',50000000);...
    atcorrector('HCOR',1e-06,[0 0],'PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
    atcorrector('VCOR',1e-06,[0 0],'PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
        atdrift('SD1S',0.071345,'Energy',50000000);...
   atquadrupole('QP4',0.15731,16.46009,'StrMPoleSymplectic4Pass','Energy',50000000);...
        atdrift('SD2',0.20269,'Energy',50000000);...
