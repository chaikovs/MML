function varargout = AT2_Girder_TDR_017_064_r56_02_sx_Dff412_DipMagnL_chro00
%************************************************************
...
% length, kick angle x/y
  HCOR = corrector('HCOR',1.0e-6,[0.0, 0],'StrMPoleSymplectic4Pass'); %CorrectorPass
  VCOR = corrector('VCOR',1.0e-6,[0, 0.0],'StrMPoleSymplectic4Pass');
% 
%  HCOR = rbend2('HCOR',1.0e-6,0,0,0,0,0, 'BndMPoleSymplectic4Pass');
%  VCOR = rbend2('VCOR',1.0e-6,0,0,0,0,0, 'BndMPoleSymplectic4Pass');


% HCOR = atcorrector('HCOR',1.0e-6,[0,0]);
% HCOR.PassMethod='StrMPoleSymplectic4Pass';
% HCOR.PolynomB=[0 0];
% HCOR.PolynomA=[0 0];
% HCOR.MaxOrder=1;
%  
% VCOR = atcorrector('VCOR',1.0e-6,[0,0]);
% VCOR.PassMethod='StrMPoleSymplectic4Pass';
% VCOR.PolynomB=[0 0];
% VCOR.PolynomA=[0 0];
% VCOR.MaxOrder=1;
 %%==========================
...
GS =  marker('GS','IdentityPass');
GE   =  marker('GE','IdentityPass');
...
str1 = [SD5B GS BPM SD5 QP1 SD2 QP2 GE SD31];
cell1 = [GS BEND SD3S2 SX1 HCOR VCOR SD3S QP31 SD3S SX3 HCOR VCOR SD3S1 QP41 SD1S1B BPM SD1S1 SX2 HCOR VCOR SD1S QP4 SD2 QP3 SD2SB BPM SD2S BEND GE SD0];
cell2 = [SD0 GS BEND SD2S BPM SD2SB QP3 SD2 QP4 SD1S SX2 HCOR VCOR SD1S1 BPM SD1S1B QP41 SD3S1 SX3 HCOR VCOR SD3S QP31 SD3S SX1 HCOR VCOR SD3S2 BEND GE];
str2 = [SD31 GS QP2 SD2 QP1 SD5 BPM GE SD5B];
