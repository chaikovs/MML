function varargout = TDR_017_064_r56_02_sx_Dff412_DipMagnL_chro00_QuadMagnL
%************************************************************
...
% disp(['** Loading THOMX ring lattice ', mfilename]);
 ...
 L0 =  17.986715999999998; %17.986704000000003; % design circumference length [m]; 
...
SD31 = drift('SD31', 0.7537500E+00 - dL - dL_quad, 'DriftPass');
...
QP1 = quadrupole('QP1', LQP, -.5224255E+01, QPassMethod);
QP2 = quadrupole('QP2', LQP, 0.9932617E+01, QPassMethod);
QP3 = quadrupole('QP3', LQP, -.1790965E+02, QPassMethod);
QP4 = quadrupole('QP4', LQP, 0.1573870E+02, QPassMethod);
QP31 = quadrupole('QP31', LQP, -.9296938E+01, QPassMethod);
QP41 = quadrupole('QP41', LQP,  0.6001486E+01, QPassMethod);
...
%  SX3 = sextupole('SX3', LSX, -.3289547E+01/LSX*sx_on, SPassMethod); 
 ...
 SX1 = sextupole('SX1', 0.1000000E-05, -.8188227E+07*sx_on,  SPassMethod); 
 SX2 = sextupole('SX2', 0.1000000E-05,  0.2376682E+07*sx_on, SPassMethod); 
