...
QP1 = quadrupole('QP1', LQP, -.3374779E+01, QPassMethod);
QP2 = quadrupole('QP2', LQP, 0.8089135E+01, QPassMethod);
QP3 = quadrupole('QP3', LQP, -.1734813E+02, QPassMethod);
QP4 = quadrupole('QP4', LQP, 0.1714063E+02, QPassMethod);
QP31 = quadrupole('QP31', LQP, -.1103238E+02, QPassMethod);
QP41 = quadrupole('QP41', LQP, 0.4859609E+01, QPassMethod);
