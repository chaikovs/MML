function varargout = TDR_017_064_r56_02_sx_Dff0_DipMagnL_chro00
%************************************************************
...
theta = 0.785398;
thetae = 0;%0.03320;% 1.9 deg
thetas = 0;%0.03320;% 1.9 deg
K =0.0;
beta_gap=0.04;
...
QP1 = quadrupole('QP1', LQP, -.4923944E+01, QPassMethod);
QP2 = quadrupole('QP2', LQP, 0.9617764E+01, QPassMethod);
QP3 = quadrupole('QP3', LQP, -.1817656E+02, QPassMethod);
QP4 = quadrupole('QP4', LQP, 0.1602547E+02, QPassMethod);
QP31 = quadrupole('QP31', LQP,-.1131695E+02, QPassMethod);
QP41 = quadrupole('QP41', LQP, 0.7293505E+01, QPassMethod);
...
%  SX3 = sextupole('SX3', LSX, -.3289547E+01/LSX*sx_on, SPassMethod); 
 ...
 SX1 = sextupole('SX1', 0.1000000E-05, -.1762956E+07*sx_on,  SPassMethod); 
 SX2 = sextupole('SX2', 0.1000000E-05,  0.2656769E+07*sx_on, SPassMethod); 
 SX3 = sextupole('SX3', 0.1000000E-05, -.5746022E+07*sx_on, SPassMethod); 
