function varargout = TDR_good_017_064_r56_02_sx_Dff_CORR_entrance_exit
%************************************************************
...
%  tune=3.17  1.64 - C=17.9867m h=30 (BPM + COR)
%************************************************************
 ...
 L0 =  17.986715999999991;%17.986704000000003;%17.986692; % design circumference length [m]; 
...
SD1S1 = drift('SD1S1', 0.2500000E+00-LSX/2, 'DriftPass');
...
SD2S = drift('SD2S', 0.2350000E+00/2, 'DriftPass');
...
% length, kick angle x/y
 ...
 HCORT = corrector('HCORT',0,[0.0, 0],'CorrectorPass');
 VCORT = corrector('VCORT',0,[0, 0.0],'CorrectorPass');
 %%==========================
 %   MARKER
 %%==========================
...
str1 = [SD5 BPMx BPMz QP1 SD2 QP2 SD31];
%str1 = [SD5 BPMx BPMz QP1 SD2 QP2 SD31h KICKer SD31h];
cell1 = [HCORT VCORT BEND HCORT VCORT SD3S2 SX1 HCOR VCOR SD3S QP31 SD3S SX3 HCOR VCOR SD3S1 QP41 BPMx BPMz SD1S1 SX2 HCOR VCOR SD1S QP4 SD2 QP3 SD2S BPMx BPMz SD2S HCORT VCORT BEND HCORT VCORT SD0];
cell2 = [SD0 HCORT VCORT BEND HCORT VCORT SD2S BPMx BPMz SD2S QP3 SD2 QP4 SD1S SX2 HCOR VCOR SD1S1 BPMx BPMz QP41 SD3S1 SX3 HCOR VCOR SD3S QP31 SD3S SX1 HCOR VCOR SD3S2 HCORT VCORT BEND HCORT VCORT];
str2 = [SD31 QP2 SD2 QP1 BPMx BPMz SD5];


ELIST =[DEBUT SEPT str1 cell1 cell2 str2 RF str1 cell1 cell2 str2 FIN];
