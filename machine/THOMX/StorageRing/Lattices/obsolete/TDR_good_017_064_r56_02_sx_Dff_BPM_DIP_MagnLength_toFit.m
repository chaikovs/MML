function varargout = TDR_good_017_064_r56_02_sx_Dff_BPM_DIP_MagnLength_toFit
%************************************************************
...
%  BETA-LNS v8.06 /04/02/14/ 2015/02/25 09:08:1                                    
                                
% Thomx-hexagone tune=3.17/1.64 chro=0/0 r56=-0.22 LDff=83.5mm h=30 good lattice                       
%
%
...
%
%  tune=3.17  1.64 - C=17.9867m h=30 (BPM in good locations + COR + IP)
%************************************************************
 ...
 L0 = 17.986715999999991;%17.986715999999987; % design circumference length [m]; 
...
% dipole
%========================
L = 0.296233; %0.27646; % 0.296233 m @ 159.2475 A <=> 50 MeV
theta = 0.785398;
thetae = 0.0;
thetas = 0.0;
K =0.0;
