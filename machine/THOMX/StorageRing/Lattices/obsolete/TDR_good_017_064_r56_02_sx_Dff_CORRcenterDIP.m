function varargout = TDR_good_017_064_r56_02_sx_Dff_CORR
%************************************************************
...
SD1S1B = drift('SD1S1', 0.600000E-01, 'DriftPass');
...
SD5B = drift('SD5', 0.7400000E+00, 'DriftPass');
...
SD2SB = drift('SD2S', 0.4000000E-01, 'DriftPass');
...
BEND1  =  rbend3('BEND', L*1/2, theta*1/2, thetae, 0, K,fullgap,edge_effect1,0,'BndMPoleSymplecticNew4Pass');
BEND2  =  rbend3('BEND', L*1/2, theta*1/2, 0, thetas, K,fullgap,0,edge_effect2,'BndMPoleSymplecticNew4Pass');
BEND=[BEND1 HCORT VCORT BEND2];
