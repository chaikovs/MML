function varargout = TDR_017_064_r56_02_sx_412_DipMagnL_chro00
%************************************************************
...
% BEND  =  rbend('BEND', L, theta, thetae, thetas, K, ...
%               'BndMPoleSymplecticNew4Pass'); 

%BEND  =  rbend2('BEND', L, theta, thetae, thetas, K,fullgap, 'BndMPoleSymplecticNew4Pass');
...
QP1 = quadrupole('QP1', LQP, -.4798733E+01, QPassMethod);
QP2 = quadrupole('QP2', LQP, 0.9737264E+01, QPassMethod);
QP3 = quadrupole('QP3', LQP, -.1795199E+02, QPassMethod);
QP4 = quadrupole('QP4', LQP, 0.1610103E+02, QPassMethod);
QP31 = quadrupole('QP31', LQP, -.9196514E+01, QPassMethod);
QP41 = quadrupole('QP41', LQP, 0.6796792E+01, QPassMethod);
...
%  SX3 = sextupole('SX3', LSX, -.3289547E+01/LSX*sx_on, SPassMethod); 
 ...
 SX1 = sextupole('SX1', 0.1000000E-05, -.7080240E+07*sx_on,  SPassMethod); 
 SX2 = sextupole('SX2', 0.1000000E-05,  0.2467962E+07*sx_on, SPassMethod); 
 SX3 = sextupole('SX3', 0.1000000E-05, -.3313565E+07*sx_on, SPassMethod); 
