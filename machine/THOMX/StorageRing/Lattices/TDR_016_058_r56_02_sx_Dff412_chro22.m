function varargout = TDR_016_058_r56_02_sx_Dff412_chro22
%************************************************************
...
QPassMethod = 'StrMPoleSymplectic4Pass'; % tracking method QuadMPoleFringePass

QP1 = quadrupole('QP1', LQP, -.4841188E+01, QPassMethod);
QP2 = quadrupole('QP2', LQP, 0.9391033E+01, QPassMethod);
QP3 = quadrupole('QP3', LQP, -.1840100E+02, QPassMethod);
QP4 = quadrupole('QP4', LQP, 0.1642851E+02, QPassMethod);
QP31 = quadrupole('QP31', LQP,  -.8871639E+01, QPassMethod);
QP41 = quadrupole('QP41', LQP,  0.5112609E+01, QPassMethod);
...
%  SX3 = sextupole('SX3', LSX, -.3289547E+01/LSX*sx_on, SPassMethod); 
 ...
 SX1 = sextupole('SX1', 0.1000000E-05,  -1.95342E+04*sx_on,  SPassMethod); 
 SX2 = sextupole('SX2', 0.1000000E-05,  3.46068882332E+06 *sx_on, SPassMethod); 
 SX3 = sextupole('SX3', 0.1000000E-05,  -9.9586311E+06 *sx_on, SPassMethod); 
