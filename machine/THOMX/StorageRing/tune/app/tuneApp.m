function varargout = tuneApp(varargin)
...
%      func tion named CALLBACK in NOMBREONDE_AL_DCCT.M with the given input arguments.
%
...
% Last Modified by GUIDE v2.5 14-Dec-2018 16:05:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @tuneApp_OpeningFcn, ...
                   'gui_OutputFcn',  @tuneApp_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function tuneApp_OpeningFcn(hObject, eventdata, handles, varargin)
...
% if ~strcmp(getfamilydata('Machine'),'Booster')
...
function varargout = tuneApp_OutputFcn(hObject, eventdata, handles) 
...
legendstr2 = ['nuz=', num2str(1-nuz(1)),'  f_b=',num2str(fnuz(1)) ' MHz'];
...
disp('CONTINUOUS LOOP STOPPED HERE')
...
% --- Executes during object creation, after setting all properties.
function Onde_X_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Onde_X (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate Onde_X


% --- Executes during object deletion, before destroying properties.
function Onde_X_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to Onde_X (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
