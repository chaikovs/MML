...
% James Safranek removed one of the skew quadrupoles from LOCO, because
% this skew quadrupole is now being used to reduce vertical oscillations
% from firing the kicker bump.  
% (was isext = [4 7 11 19 26 30 33 40 43 47 54 62 66 69];
isext = [4 7 19 26 30 33 40 43 47 54 62 66 69];    %indices of 13 skew sextupole (on basis of 1-72 in SPEAR 3)
isextmore1 = 1:4:length(isAT);
isextmore2 = 2:4:length(isAT);
isext = sort(unique([isext, isextmore1, isextmore2]));
isATon = isAT(isext);  
