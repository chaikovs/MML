...
BL11.Length		= 2.2;
BL11.Nslice    	= 3;
BL11.PassMethod 	= 'WigTablePass';
load('BL11table');
BL11.xtable = x;
BL11.ytable = y;
BL11.xkick = xkick;  
BL11.ykick = ykick;
BL11.PassMethod = 'DriftPass'; %added to zero out BL11

MF11mult
MF11.PassMethod = 'DriftPass'; %added to zero out MF11
...
THERING{BL11i+3} = DC11;    %note: THERING{BL11i+3} was also a DC1A family drift
ATI = atindex(THERING); % Reindex

tune = tunechrom(THERING,0)
ATI = atindex(THERING); % Reindex

save latticeprepinitwig THERING
