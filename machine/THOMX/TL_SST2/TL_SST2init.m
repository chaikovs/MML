function TL_SST2init(OperationalMode)
...
%Modified By C.Bruni @LAL, 04/2015
%==========================
...
%AD.SubMachine    = 'TL_SST2'; % Machine Name
...
%AO.(ifam).DeviceName(:,:)               = {'TL/DG-A/BPM.010'};
...
varlist.BEND1={
    ...
    2  [ 1  2] 'TL/PS-B/DP.020-DC' 1 'BEND1.02' [+0 +580]
