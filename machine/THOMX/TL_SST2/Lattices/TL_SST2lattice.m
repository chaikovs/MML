...
%% DRIFT SPACES
 ...
 SDSST2 = drift('SDSST1', 0.3435E+00,'DriftPass'); % distance BPM strieline à SST2
...
QP1L  =  quadrupole('QP1L', LQP, -2.19458E+00, QPassMethod);
QP2L  =  quadrupole('QP2L', LQP, 1.11856E+01, QPassMethod);
QP3L  =  quadrupole('QP3L', LQP,-0.9083080E+01, QPassMethod);
QP4L  =  quadrupole('QP4L', LQP, 0.580722E+01, QPassMethod);
QP5L  =  quadrupole('QP5L', LQP, 0.580707E+01, QPassMethod);
QP6L  =  quadrupole('QP6L', LQP,-0.95977E+01, QPassMethod);
QP7L  =  quadrupole('QP7L', LQP, 0.971166E+01, QPassMethod);
...
ELIST =[DEBUT ...
 ...
 SDIL21   HCOR   VCOR     SDIL22   BPMx    BPMz    SDSST2 FIN];
