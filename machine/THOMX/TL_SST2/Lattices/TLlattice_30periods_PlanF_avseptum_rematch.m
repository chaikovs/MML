...
%% DRIFT SPACES
 ...
 SD1L2  = drift('SD1L2', 0.100000E+00,'DriftPass');
 SD2L  = drift('SD2L', 0.200000E+00,'DriftPass');
 SD3L  = drift('SD3L', 0.080000E+00,'DriftPass');
 SD3L1  = drift('SD3L1', 0.1205000E+00,'DriftPass');
 SD3L2  = drift('SD3L2', 0.4995000E+00,'DriftPass');
 SD4L  = drift('SD4L', 0.400000E+00,'DriftPass');
 SDDL1 = drift('SDDL1', 0.115230E+01,'DriftPass');
 SDDL2 = drift('SDDL2', 0.118000E+00,'DriftPass');
 SDDL3 = drift('SDDL3', 0.1862750E+01,'DriftPass');
 SDIL31 = drift('SDIL31', 0.1105000E+00,'DriftPass');
 ...
 SDIL23 = drift('SDIL22', 0.753500E+00,'DriftPass');
...
QP1L  =  quadrupole('QP1L', LQP, -0.0482006E+00, QPassMethod);
QP2L  =  quadrupole('QP2L', LQP, 0.9865800E+01, QPassMethod);
QP3L  =  quadrupole('QP3L', LQP,-0.9711650E+01, QPassMethod);
QP4L  =  quadrupole('QP4L', LQP, 0.5879120E+01, QPassMethod);
QP5L  =  quadrupole('QP5L', LQP, 0.5151820E+01, QPassMethod);
QP6L  =  quadrupole('QP6L', LQP,-0.1095270E+02, QPassMethod);
QP7L  =  quadrupole('QP7L', LQP, 0.1119830E+02, QPassMethod);
