...
if exist('SubMachineName', 'var') && ~strcmpi(SubMachineName, 'TL') && ~strcmpi(SubMachineName, 'TL_SST2')
...
if ~isdeployed_local
    ...
    addpath(fullfile(MMLROOT, 'machine', 'THOMX', 'TL_SST2'));
    addpath(fullfile(MMLROOT, 'machine', 'THOMX', 'TL_SST2', 'lattices'));
