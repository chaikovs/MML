    ...
    case 'UIControls'                           %  UIControls
        ...
        switch Machine
            case {'TL', 'ET'}
                ...
                col1_families={'BEND1';'BEND2'; 'HCOR' ; 'VCOR'};
                col2_families={'QP1L';'QP2L'; 'QP3L'; 'QP4L'};
                col3_families={'QP5L';'QP6L'; 'QP7L'};
                ...
                uicontrol('Style','pushbutton','units', 'centimeters','FontWeight','demi', ...
                    ...
                    'Position',[x0+(x1-0.1)*dx,y0-3*dely,3.5*dx,dy/2],'HorizontalAlignment','center','String','Display Main Configuration');
                
                %display full configuration
                uicontrol('Style','pushbutton','units', 'centimeters','FontWeight','demi', ...
                    'ToolTipString','Print configuration data to screen',...
                    'Callback','configgui(''ShowConfiguration'')',...
                    'Position',[x0+(x1-0.1)*dx,y0-4*dely,3.5*dx,dy/2],'HorizontalAlignment','center','String','Display Full Configuration');
                ...
                cnfdata.handles.GetDesired=uicontrol('Style','PushButton','units', 'centimeters', ...
                    ...
                    'Callback','configgui(''GetDesiredConfig'')','Enable','off');
                ...
                uicontrol('Style','PushButton','units', 'centimeters', ...
                    ...
                    'Position',[x0+x1*dx,y0-8.6*dely,1.2*dx,dy/2],'HorizontalAlignment','center','String','Desired',...
                    'Callback','configgui(''SetDesiredConfig'')','Enable','off');
...
%                 end
    ...
    case 'GetDesiredConfig'
        ...
        %% switch between the online mode and simulator Modified by Jianfeng Zhang @ LAL, 20/10/2013
        %   should I always use the "online" mode for ThomX ????
        %family1 = cnfdata.families{1}; online or simulator???
        mode =  cnfdata.SetpointData.HCOR.Setpoint.Mode;
     
        %get configuration from machine or simulator 
        [cnfdata.SetpointData,cnfdata.MonitorData]=getmachineconfig(mode);
        %[cnfdata.SetpointData,cnfdata.MonitorData]=getmachineconfig('online');
    ...
    case 'ShowConfiguration'          %*** ShowConfiguration ***
        ...
        if ismac || isunix
            ...
            system(['edit ', filename, ' &']);  % much faster
        end
