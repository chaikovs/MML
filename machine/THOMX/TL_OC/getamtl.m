function [AM, tout, DataTime, ErrorFlag] = getamtl(varargin)
...
%
%  See also getsp setsp getpv setpv
%
%  Written by Greg Portmann


if nargout < 3
    [AM, tout] = getpvtl(varargin{:});
else
    [AM, tout, DataTime, ErrorFlag] = getpvtl(varargin{:});
end
